...
class GeneralSettingsController extends Controller
{
    ...
    public function update_page_settings(Request $request)
    {
        $this->validate($request, [
            ...
            'list_page_slug' => 'required|string|max:191',
            'team_page_slug' => 'required|string|max:191',
            'faq_page_slug' => 'required|string|max:191',
            'author_page_slug' => 'required|string|max:191',
            ...
            'case_study_page_slug' => 'required|string|max:191',
        ]);
        $slug_list = [
            'video_gallery',
            'about','service','work','list','team',
            'faq', 'author', 'price_plan','blog','contact',
            ...
            'courses','support_ticket','case_study'
        ];
        ...
        foreach ($all_languages as $lang) {
            $this->validate($request, [
                ...
                'list_page_' . $lang->slug . '_name' => 'nullable|string',
                'team_page_' . $lang->slug . '_name' => 'nullable|string',
                'faq_page_' . $lang->slug . '_name' => 'nullable|string',
                'author_page_' . $lang->slug . '_name' => 'nullable|string',
                ...
                'case_study_page_' . $lang->slug . '_name' => 'nullable|string',
            ]);
            foreach ($slug_list as $field) {
                ...
                $schema_code = $field.'_page_' . $lang->slug . '_schema_code';
                ...
                update_static_option($schema_code, $request->$schema_code);
    ...
    public function update_seo_settings(Request $request)
    {
        ...
        foreach ($all_languages as $lang) {
            ...
            $schema_code = 'site_meta_' . $lang->slug . '_schema_code';
            //echo $schema_code;die;

...
class PricePlanController extends Controller
{
    ...
    public function store(Request $request){
        $this->validate($request,[
            ...
            'monthly_price' => 'required|string|max:191',
            'annual_price' => 'required|string|max:191',
            'monthly_original_price' => 'required|string|max:191',
            'annual_original_price' => 'required|string|max:191',
            'monthly_bill_text' => 'nullable|string',
            'annual_bill_text' => 'nullable|string',
    ...
    public function update(Request $request){
        ...
        PricePlan::find($request->id)->update(
            [
                ...
                'monthly_original_price' => $request->monthly_original_price,
                'annual_original_price' => $request->annual_original_price,
                'monthly_bill_text' => $request->monthly_bill_text,
                'annual_bill_text' => $request->annual_bill_text,
                'lang' => $request->lang,
                'type' => $request->type,
    ...
    public function category_bulk_action(Request $request){
        PricePlanCategory::whereIn('id',$request->ids)->delete();
        return response()->json(['status' => 'ok']);
    }
}

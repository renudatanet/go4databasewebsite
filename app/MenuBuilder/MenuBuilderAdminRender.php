...
class MenuBuilderAdminRender
{
    ...
    private function get_draggable_fields_markup(array $attributes_string,$lang)
    {
        ...
        if(isset($attributes_string['menutitle']) && $attributes_string['menutitle']!='')
        {
            $output .= '<input type="text" class="menu_title" placeholder="Enter your title" value="'.$attributes_string['menutitle'].'" style="display:none;">';
        }
        else{
            $output .= '<input type="text" class="menu_title" placeholder="Enter your title" value="" style="display:none;">';
        } 
        //check menu type

...
class AboutSectionStyleFive extends PageBuilderBase
{
    /**
     * preview_image
...
HTML;
        ...
        return <<<HTML
<div class="lawyer-about-area political-home" data-padding-top="{$padding_top}" data-padding-bottom="{$padding_bottom}">
       <div class="container">
        <div class="row">
            <div class="col-lg-6">

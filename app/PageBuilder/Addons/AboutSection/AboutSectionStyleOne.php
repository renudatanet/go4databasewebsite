...
class AboutSectionStyleOne extends PageBuilderBase
{
    ...
    public function frontend_render(): string
    {
        ...
        if (!empty($button_url) && !empty($button_text)){
            $button_markup .= ' <div class="btn-wrapper"><a href="'.$button_url.'" class="btn-boxed cleaning-home">'.$button_text.'</a></div>';
        }

        return <<<HTML
<div class="cleaning-about-area-wrap" data-padding-top="{$padding_top}" data-padding-bottom="{$padding_bottom}" >
       <div class="container">
        <div class="row">
            <div class="col-lg-6">

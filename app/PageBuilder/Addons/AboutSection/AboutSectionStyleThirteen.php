...
class AboutSectionStyleThirteen extends PageBuilderBase
{
    use RepeaterHelper;
    /**
     * preview_image
    ...
    public function frontend_render(): string
    {
        ...
        $right_image = render_background_image_markup_by_attachment_id($settings['right_image']);
...
<div class="quality-area"  >
    <div class="container-fluid p-0">
        <div class="row no-gutters">
            <div class="col-lg-6">
                <div class="quality-img" {$right_image}></div>
            </div>  
            <div class="col-lg-6">
                <div class="quality-content" data-padding-top="{$padding_top}" data-padding-bottom="{$padding_bottom}" {$background_color}>

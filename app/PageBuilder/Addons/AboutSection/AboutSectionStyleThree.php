...
class AboutSectionStyleThree extends PageBuilderBase
{
    /**
     * preview_image
    ...
    public function admin_render()
    {
        ...
        foreach ($all_languages as $key => $lang) {
            ...
            $output .= Image::get([
                'name' => 'right_bottom_image_'.$lang->slug,
                'label' => __('Right Bottom Image'),
                'value' => $widget_saved_values['right_bottom_image_' . $lang->slug] ?? null,
                'dimensions' => '320x270px'
            ]);
            $output .= Image::get([
    ...
    public function frontend_render(): string
    {
        ...
        $right_bottom_image = render_image_markup_by_attachment_id($settings['right_bottom_image_'.$current_lang],'','full');

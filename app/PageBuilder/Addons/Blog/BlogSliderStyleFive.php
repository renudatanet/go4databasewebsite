...
class BlogSliderStyleFive extends PageBuilderBase
{
...
<div class="single-portfolio-blog-grid portfolio-page">
    <div class="thumb">
         {$image}
        <div class="time-wrap">
...
<div class="row">
    <div class="col-lg-12">
        <div class="section-title white margin-bottom-60 {$section_title_alignment}">
            {$sub_title_markup}
...
HTML;
        ...
        return <<<HTML
<div class="portfolio-news-area dark-section-bg-two" data-padding-top="{$padding_top}" data-padding-bottom="{$padding_bottom}" {$background_color}>
    <div class="container">
        {$section_title_markup}
        <div class="row">
            <div class="col-lg-12">
                <div class="global-carousel-init pcarousel-dots"
                     data-loop="true"

...
class BlogSliderStyleTwo extends PageBuilderBase
{
...
HTML;
        ...
        return <<<HTML
<div class="const-news-area dagency-bg-color" data-padding-top="{$padding_top}" data-padding-bottom="{$padding_bottom}">
    <div class="container">
        {$section_title_markup}
        <div class="row">
            <div class="col-lg-12">

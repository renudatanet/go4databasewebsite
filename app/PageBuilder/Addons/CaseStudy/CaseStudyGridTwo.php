...
class CaseStudyGridTwo extends PageBuilderBase
{
    ...
    {
       return 'case-study/slider-02.png';
    }
...
<div class="col-md-6 {$columns}">
    <div class="const-single-case-study-style-02 lawyer-home margin-bottom-30">
        <div class="thumb">
            {$image_markup}
        </div>
        <div class="cart-icon">
            <h4 class="title"><a href="{$route}"> {$title}</a></h4>
            <div class="cat-wrapper"> {$cat_markup}</div>
        </div>
    </div>
</div>
HTML;

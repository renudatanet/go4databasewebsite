...
class CaseStudyMasornyTwo extends PageBuilderBase
{
    ...
    public function frontend_render()
    {
        ...
        foreach ($all_case_study as $item){
            ...
            $routecat = route('frontend.work.single', Str::slug($name));
                //$cat_markup .= '<a href="'.route('frontend.works.category',['slug' =>  Str::slug($name)]).'">'.$name.'</a>';
                $cat_markup .= '<a href="'.$routecat.'">'.$name.'</a>';
            }

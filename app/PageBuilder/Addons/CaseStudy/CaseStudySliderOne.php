...
class CaseStudySliderOne extends PageBuilderBase
{
...
<div class="row ">
    <div class="col-lg-12">
        <div class="section-title desktop-center medical-home margin-bottom-60 {$section_title_alignment}">
            {$section_subtitle_markup}
...
<div class="medical-project-area" data-padding-top="{$padding_top}" data-padding-bottom="{$padding_bottom}">
    <div class="container">
        {$section_title_markup}
    </div>
...
HTML;
    ...
    {
        return __('Case Study Slider: 01');
    }
}
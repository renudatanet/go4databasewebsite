...
class CaseStudySliderThree extends PageBuilderBase
{
    ...
    {
       return 'case-study/slider-03.png';
    }
    ...
    public function admin_render()
    {
        ...
        $output .= Slider::get([
            ...
            'value' => $widget_saved_values['stage_padding'] ?? 200,
            'info' => __('you can manage stage padding of this slider'),
            'max' => 500,
            'unit_type' => ''
        ]);
        $output .= Notice::get([
    ...
    public function frontend_render()
    {
        ...
        $stage_padding = SanitizeInput::esc_html($settings['stage_padding']);
...
<div class="logistic-project-area" data-padding-top="{$padding_top}" data-padding-bottom="{$padding_bottom}">
    <div class="container">
        <div class="row">
            <div class="col-lg-8">
...
HTML;
    ...
    {
        return __('Case Study Slider: 03');
    }
}
...
class CounterupAreaStyleEight extends PageBuilderBase
{
...
HTML;
        ...
        return <<<HTML
<div class="logistic-counterup-area bg-overlay"  data-padding-top="{$padding_top}" data-padding-bottom="{$padding_bottom}" {$background_image} data-margin-minus-top="{$margin_top_minus}">
    <div class="container">
        <div class="row">
             {$counterup_item_markup}
        </div>

...
class CounterupAreaStyleFive extends PageBuilderBase
{
    ...
    public function admin_render()
    {
        ...
        $output .= Select::get([
            ...
            'label' => __('Theme'),
            'options' => [
                'political-home' => __('Style 01'),
                'lawyer-home' => __('Style 02'),
            ],
...
HTML;
        ...
        return <<<HTML
<div class="lawyer-counterup-area {$theme}" data-padding-top="{$padding_top}" data-padding-bottom="{$padding_bottom}" {$background_image}>
    <div class="container">
        <div class="row">
             {$counterup_item_markup}
        </div>

...
class CounterupAreaStyleNine extends PageBuilderBase
{
...
<div class="col-lg-3 col-md-6">
    <div class="single-counterup-03">
        <div class="number">{$number}{$extra_text}</div>
...
HTML;
        ...
        return <<<HTML
<div class="portfolio-counterup-area  dark-section-bg-two"  data-padding-top="{$padding_top}" data-padding-bottom="{$padding_bottom}" {$background_color}">
    <div class="container">
        <div class="row">
             {$counterup_item_markup}
        </div>

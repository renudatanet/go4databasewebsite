...
class CounterupAreaStyleSeven extends PageBuilderBase
{
...
HTML;
        ...
        return <<<HTML
<div class="industry-counterup-area bg-overlay"  data-padding-top="{$padding_top}" data-padding-bottom="{$padding_bottom}" {$background_image}>
    <div class="container">
        <div class="row">
             {$counterup_item_markup}
        </div>

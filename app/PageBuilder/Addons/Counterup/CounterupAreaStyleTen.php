...
class CounterupAreaStyleTen extends PageBuilderBase
{
...
HTML;
        ...
        return <<<HTML
<div class="counterup-area counterup-bg"  data-padding-top="{$padding_top}" data-padding-bottom="{$padding_bottom}" {$background_color}">
    <div class="container">
        <div class="row">
             {$counterup_item_markup}
        </div>

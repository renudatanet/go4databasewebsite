...
class CallToActionStyleFive extends PageBuilderBase
{
    use RepeaterHelper;
    /**
     * preview_image
    ...
    public function frontend_render(): string
    {
        ...
        return <<<HTML
<div class="charity-cta-two-area" data-padding-top="{$padding_top}" data-padding-bottom="{$padding_bottom}" data-margin-minus-top="{$margin_top_minus}">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="cta-inner">

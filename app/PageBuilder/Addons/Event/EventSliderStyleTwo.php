...
class EventSliderStyleTwo extends PageBuilderBase
{
...
<div class="row">
    <div class="col-lg-12">
        <div class="section-title margin-bottom-60 charity-home {$section_title_alignment}">
...
HTML;
        ...
        return <<<HTML
<div class="charity-event-area" data-padding-top="{$padding_top}" data-padding-bottom="{$padding_bottom}">
    <div class="container">
        {$section_title_markup}
        <div class="row">
            <div class="col-lg-12">
                <div class="event-carousel-wrapper global-carousel-init logistic-dots"
                     data-loop="true"

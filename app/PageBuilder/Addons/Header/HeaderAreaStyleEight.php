...
class HeaderAreaStyleEight extends PageBuilderBase
{
    ...
    {
       return 'header-area-style-08.png';
    }
    ...
    public function admin_render()
    {
        ...
        $output .= Slider::get([
            ...
            'value' => $widget_saved_values['padding_top'] ?? 280,
            'max' => 500,
        ]);
        $output .= Slider::get([
            'name' => 'padding_bottom',
            'label' => __('Padding Bottom'),
            'value' => $widget_saved_values['padding_bottom'] ?? 380,
            'max' => 500,
        ]);
    ...
    public function frontend_render()
    {
        ...
        return <<<HTML
<div class="header-slider-wrapper cleaning-home" {$background_image} >
    <div class="right-image-wrap">
       {$right_image}
    </div>
    <div class="header-area cleaning-home" data-padding-top="{$padding_top}" data-padding-bottom="{$padding_bottom}">
        <div class="container">
            <div class="row">
                <div class="col-lg-7">
                    <div class="header-inner">
                        ...
                        <div class="btn-wrapper margin-top-30">
                             <a href="{$button_url}" class="btn-boxed cleaning-home">{$button_text}</a>
                        </div>
                    </div>
                </div>
            </div>

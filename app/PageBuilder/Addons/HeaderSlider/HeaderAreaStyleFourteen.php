...
class HeaderAreaStyleFourteen extends PageBuilderBase
{
    use RepeaterHelper;
    /**
     * preview_image
    ...
    {
        return 'header-area-style-14.png';
    }
    ...
    {
        $output = '<div class="header-slider-wrapper global-carousel-init grocery-home renu4" data-loop="true" data-desktopitem="1" data-mobileitem="1" data-tabletitem="1" data-dots="false" data-nav="true"  data-autoplay="true" data-stagepadding="0" data-margin="0">';
    ...
    private function render_slider_markup(int $index = null): string
    {
        ...
        $button_two_text = $this->get_repeater_field_value('button_two_text', $index, LanguageHelper::user_lang_slug());
        $button_two_url = $this->get_repeater_field_value('button_two_url', $index, LanguageHelper::user_lang_slug());
        ...
        if (!empty($button_one_text) && !empty($button_one_url)){
            $button_markup .= ' <a href="'.$button_one_url.'" class="logistics-btn">'.$button_one_text.'</a> ';
        }
        if (!empty($button_two_text) && !empty($button_two_url)){
            $button_markup .= ' <a href="'.$button_two_url.'" class="logistics-btn blank">'.$button_two_text.'</a> ';
        }
        ...
        return <<<HTML
    <div class="header-area style-04 header-bg-04 logistics-home" data-padding-top="{$padding_top}" data-padding-bottom="{$padding_bottom}"
        {$background_image}
        >
        <div class="container">

...
class HeaderAreaStyleTen extends PageBuilderBase
{
    use RepeaterHelper;
    /**
     * preview_image
    ...
    {
        return 'header-area-style-10.png';
    }
    ...
    public function admin_render()
    {
        ...
        $output .= Repeater::get([
            ...
            'id' => 'header_ten', //this should be unique
            'fields' => [
                [
    ...
    private function render_slider_markup(int $index = null): string
    {
        ...
        if (!empty($button_text) && !empty($button_url)){
            ...
            $button_markup = '<div class="btn-wrapper margin-top-30">  <a href="'.$button_url.'" class="btn-dagency">'.$button_text.' '.$icon_markup.'</a> </div>';
        }
        $padding_top = SanitizeInput::esc_html($settings['padding_top']);
        $padding_bottom = SanitizeInput::esc_html($settings['padding_bottom']);
        return <<<HTML
<div class="header-area grocery-home" {$background_image}  data-padding-top="{$padding_top}" data-padding-bottom="{$padding_bottom}">
            <div class="container">
                <div class="row">
                    <div class="col-lg-6">

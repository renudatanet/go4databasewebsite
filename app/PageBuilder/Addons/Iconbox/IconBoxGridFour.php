...
class IconBoxGridFour extends PageBuilderBase
{
    protected $a = 1;
    use RepeaterHelper;
    /**
...
<div class="row">
   <div class="col-lg-12">
       <div class="section-title desktop-center margin-bottom-60 industry-home {$section_title_alignment}">

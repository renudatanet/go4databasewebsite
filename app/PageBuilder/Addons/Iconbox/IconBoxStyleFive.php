...
class IconBoxStyleFive extends PageBuilderBase
{
    use RepeaterHelper;
    /**
     * preview_image
    ...
    public function frontend_render(): string
    {
        ...
        <div class="container">
        <div class="header-bottom-inner style-02" data-margin-minus-top="'.$margin_top_minus.'">';

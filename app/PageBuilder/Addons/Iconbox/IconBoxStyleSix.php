...
class IconBoxStyleSix extends PageBuilderBase
{
    use RepeaterHelper;
    /**
     * preview_image
    ...
    public function admin_render()
    {
        ...
        $output .= Slider::get([
            ...
            'value' => $widget_saved_values['margin_top_minus'] ?? 1,
            'max' => 500,
        ]);
        $output .= Slider::get([
            'name' => 'padding_top',
    ...
    public function frontend_render(): string
    {
        ...
        $output = '<div class="header-bottom-area bg-blue" 
        data-padding-top="'.$padding_top.'" 
        data-padding-bottom="'.$padding_bottom.'" '.$background_color.'>
        <div class="container">
        <div class="header-bottom-inner" data-margin-minus-top="'.$margin_top_minus.'">';
...
<div class="col-lg-3 col-md-6 col-sm-6">
    <div class="single-header-bottom-item style-0{$a} margin-bottom-30">
        <div class="icon">
            <i class="{$icon}"></i>
        </div>
        <div class="content">

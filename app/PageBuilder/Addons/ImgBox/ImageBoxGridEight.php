...
class ImageBoxGridEight extends PageBuilderBase
{
    protected $a = 1;
    use RepeaterHelper;
    /**
...
HTML;
    ...
    private function render_slider_markup(int $index)
    {
        ...
        $a >= 6 ? $this->a = 1 : $this->a++;
        if (!empty($icon)){
            $icon_markup = '<div class="icon-02 style-0'.$a.'"><i class="'.$icon.'"></i></div>';
        }
        return <<<HTML

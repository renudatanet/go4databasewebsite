...
class ServiceCategoryGridStyleOne extends PageBuilderBase
{
    ...
    {
        return 'service/category-grid-01.png';
    }
    ...
    public function frontend_render()
    {
        ...
        $services = ServiceCategory::query()->where(['status' => 'publish','lang' => $current_lang])->orderBy($order_by, $order);
        ...
        foreach ($services as $service) {
            $route = route('frontend.services.category',[ 'id' => $service->id , 'any' => Str::slug($service->name)]);
            $image = render_image_markup_by_attachment_id($service->image);
            $title = SanitizeInput::esc_html($service->name);
...
<div class="col-lg-3 col-md-6">
    <div class="single-cleaning-service-item margin-top-30 margin-bottom-50 ">
        <div class="thumb">
...
<div class="row justify-content-between ">
   <div class="col-lg-12">
       <div class="section-title desktop-center margin-bottom-60 cleaning-home {$section_title_alignment}">
...
HTML;
    ...
    {
        return __('Service Category Grid: 01');
    }
}
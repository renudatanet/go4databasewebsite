...
class ServiceCategoryGridStyleTwo extends PageBuilderBase
{
    ...
    {
        return 'service/category-grid-02.png';
    }
    ...
    public function frontend_render()
    {
        ...
        foreach ($services as $service) {
            ...
            if($service->icon_type === 'icon' || $service->icon_type == ''){
                $icon_markup = '<div class="icon style-'.$a.'">
...
<div class="row justify-content-between ">
   <div class="col-lg-12">
       <div class="section-title desktop-center margin-bottom-100 dagency-home {$section_title_alignment}">
...
HTML;
    ...
    {
        return __('Service Category Grid: 02');
    }
}
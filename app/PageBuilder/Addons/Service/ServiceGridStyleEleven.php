...
class ServiceGridStyleEleven extends PageBuilderBase
{
...
HTML;
        ...
        return <<<HTML
<div class="what-we-cover bg-image" data-padding-top="{$padding_top}" data-padding-bottom="{$padding_bottom}" {$background_image}>
    <div class="container">
        {$section_title_markup}
        <div class="row">
            {$item_markup}

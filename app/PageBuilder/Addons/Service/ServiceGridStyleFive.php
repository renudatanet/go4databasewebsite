...
class ServiceGridStyleFive extends PageBuilderBase
{
...
<div class="row justify-content-between ">
   <div class="col-lg-12">
       <div class="section-title margin-bottom-60 lawyer-home {$section_title_alignment}">
...
HTML;
        ...
        return <<<HTML
<div class="lawyer-what-we-offer-area industry-section-bg " data-padding-top="{$padding_top}" data-padding-bottom="{$padding_bottom}">
    <div class="container">
        {$section_title_markup}
        <div class="row">
            {$item_markup}

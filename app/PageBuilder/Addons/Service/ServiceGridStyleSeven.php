...
class ServiceGridStyleSeven extends PageBuilderBase
{
...
<div class="row justify-content-between ">
   <div class="col-lg-12">
       <div class="section-title padding-bottom-100  {$section_title_alignment}">
...
HTML;
        ...
        return <<<HTML
<div class="logistics-what-we-offer-area" data-padding-top="{$padding_top}" data-padding-bottom="{$padding_bottom}">
    <div class="container">
        {$section_title_markup}
        <div class="row">
            {$item_markup}

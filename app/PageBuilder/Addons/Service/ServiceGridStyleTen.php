...
class ServiceGridStyleTen extends PageBuilderBase
{
...
HTML;
        ...
        return <<<HTML
<div class="what-we-offer-area dark-section-bg-two " data-padding-top="{$padding_top}" data-padding-bottom="{$padding_bottom}" {$background_color}>
    <div class="container">
        {$section_title_markup}
        <div class="row">
            {$item_markup}

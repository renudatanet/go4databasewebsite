...
class TeamGridStyleThree extends PageBuilderBase
{
...
<div class="col-md-6 {$columns}">
    <div class="industry-team-single-item margin-bottom-30">
        <div class="tumb">
             {$image}
        </div>
        <div class="content">
...
HTML;
        ...
        return <<<HTML
<div class="industry-team-member-area industry-section-bg" data-padding-top="{$padding_top}" data-padding-bottom="{$padding_bottom}"  {$background_color}>
    <div class="container">
        {$section_title_markup}
        <div class="row">
             {$category_markup}

...
class TeamSliderStyleThree extends PageBuilderBase
{
...
HTML;
        ...
        return <<<HTML
<div class="industry-team-member-area industry-section-bg" data-padding-top="{$padding_top}" data-padding-bottom="{$padding_bottom}" style="background-color: {$background_color}">
    <div class="container">
        {$section_title_markup}
        <div class="row">
            <div class="col-lg-12">

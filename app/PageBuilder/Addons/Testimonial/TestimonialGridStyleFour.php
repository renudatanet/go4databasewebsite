...
class TestimonialGridStyleFour extends PageBuilderBase
{
    ...
    {
       return 'testimonial/style-05.png';
    }
...
<div class="{$columns} col-md-6">
    <div class="cagency-single-testimonial-item dagency-home margin-bottom-30">
        <div class="content">
...
<div class="row">
    <div class="col-lg-12">
        <div class="section-title desktop-center margin-bottom-60 dagency-home {$section_title_alignment}">
            {$subtitle_markup}
...
HTML;
        ...
        return <<<HTML
<div class="logistic-testimonial-area " data-padding-top="{$padding_top}" data-padding-bottom="{$padding_bottom}" {$background_color}>
    <div class="container">
        {$section_title_markup}
        <div class="row">
             {$category_markup}

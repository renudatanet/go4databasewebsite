...
class TestimonialGridStyleThree extends PageBuilderBase
{
    ...
    {
       return 'testimonial/style-03.png';
    }
...
<div class="row">
    <div class="col-lg-12">
        <div class="section-title margin-bottom-40 cleaning-home {$section_title_alignment}">
            {$subtitle_markup}
...
HTML;
        ...
        return <<<HTML
<div class="cleaning-home-testimonial-area  section-bg-1" data-padding-top="{$padding_top}" data-padding-bottom="{$padding_bottom}" {$background_color}>
    <div class="container">
        {$section_title_markup}
        <div class="row">
            {$category_markup}

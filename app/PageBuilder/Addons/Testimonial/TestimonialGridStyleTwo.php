...
class TestimonialGridStyleTwo extends PageBuilderBase
{
    ...
    {
       return 'testimonial/style-02.png';
    }
...
<div class="{$columns} col-md-6">
    <div class="const-single-testimonial-item course-home margin-bottom-30">
        <div class="content">
...
HTML;
        ...
        return <<<HTML
<div class="course-home-testimonial-area course-section-bg" data-padding-top="{$padding_top}" data-padding-bottom="{$padding_bottom}" {$background_color}>
    <div class="container">
        {$section_title_markup}
        <div class="row">
           {$category_markup}

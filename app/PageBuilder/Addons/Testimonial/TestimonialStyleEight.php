...
class TestimonialStyleEight extends PageBuilderBase
{
    ...
    {
       return 'testimonial/style-08.png';
    }
...
HTML;
        ...
        return <<<HTML
<div class="logistic-testimonial-area " data-padding-top="{$padding_top}" data-padding-bottom="{$padding_bottom}" {$background_image}>
    <div class="container">
        {$section_title_markup}
        <div class="row">
            <div class="{$column}">

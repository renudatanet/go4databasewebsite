...
class TestimonialStyleEleven extends PageBuilderBase
{
    ...
    {
       return 'testimonial/style-11.png';
    }
...
HTML;
        ...
        return <<<HTML
<div class="portfolio-testimonial-area dark-section-bg-three" data-padding-top="{$padding_top}" data-padding-bottom="{$padding_bottom}" {$background_color}>
    <div class="container">
        {$section_title_markup}
        <div class="row">
            <div class="col-lg-12">

...
class TestimonialStyleFifteen extends PageBuilderBase
{
    ...
    {
       return 'testimonial/style-15.png';
    }
    ...
    public function admin_render()
    {
        ...
        $output .= Select::get([
            ...
            'value' => $widget_saved_values['slider_column'] ?? null,
        ]);
    ...
    public function frontend_render()
    {
        ...
        $slider_column = SanitizeInput::esc_html($settings['slider_column']);

...
class TestimonialStyleFour extends PageBuilderBase
{
    ...
    {
       return 'testimonial/style-04.png';
    }
    ...
    public function frontend_render()
    {
        ...
        $background_image_markup = render_background_image_markup_by_attachment_id($background_image);
...
<div class="row">
    <div class="col-lg-12">
        <div class="section-title desktop-center margin-bottom-60 fruits-home {$section_title_alignment}">
            {$subtitle_markup}
...
HTML;
        ...
        $left_image_markup = '';
        if (!empty($left_image)) {
            $left_image_tag = render_image_markup_by_attachment_id($left_image);
...
HTML;
        ...
        return <<<HTML
<div class="fruits-testimonial-area" data-padding-top="{$padding_top}" data-padding-bottom="{$padding_bottom}" {$background_image_markup}>
    {$right_image_markup}
    {$left_image_markup}
    <div class="container">
        {$section_title_markup}

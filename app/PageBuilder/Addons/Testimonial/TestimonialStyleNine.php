...
class TestimonialStyleNine extends PageBuilderBase
{
    ...
    {
       return 'testimonial/style-09.png';
    }
...
<div class="row">
    <div class="col-lg-12">
        <div class="section-title desktop-center margin-bottom-60 lawyer-home  {$section_title_alignment}">
            {$subtitle_markup}

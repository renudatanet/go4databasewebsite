...
class TestimonialStyleThree extends PageBuilderBase
{
...
HTML;
        ...
        return <<<HTML
<div class="cleaning-home-testimonial-area  section-bg-1" data-padding-top="{$padding_top}" data-padding-bottom="{$padding_bottom}">
    <div class="container">
        {$section_title_markup}
        <div class="row">
            <div class="col-lg-12">

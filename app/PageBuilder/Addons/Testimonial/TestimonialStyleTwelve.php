...
class TestimonialStyleTwelve extends PageBuilderBase
{
    ...
    {
       return 'testimonial/style-12.png';
    }
...
HTML;
        ...
        return <<<HTML
<div class="testimonial-area bg-image-01" data-padding-top="{$padding_top}" data-padding-bottom="{$padding_bottom}" {$background_image}>
    <div class="container">
        {$section_title_markup}
        <div class="row">
            <div class="col-lg-12">

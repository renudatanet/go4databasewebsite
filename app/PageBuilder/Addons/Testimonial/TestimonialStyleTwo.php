...
class TestimonialStyleTwo extends PageBuilderBase
{
...
HTML;
        ...
        return <<<HTML
<div class="course-home-testimonial-area course-section-bg" data-padding-top="{$padding_top}" data-padding-bottom="{$padding_bottom}">
    <div class="container">
        {$section_title_markup}
        <div class="row">
            <div class="col-lg-12">

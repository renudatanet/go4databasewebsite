...
trait EventEmailTemplate
{
    ...
    {
        $message = get_static_option('event_booking_reminder_' . LanguageHelper::user_lang_slug() . '_message');
        $message = $this->parseBookingInfo($message, $booking_details);
        return [
            'subject' => get_static_option('event_booking_reminder_' . LanguageHelper::user_lang_slug() . '_subject'),
            'message' => $message,
        ];
    }
    ...
    {
        $message = get_static_option('event_booking_payment_accept_' . LanguageHelper::user_lang_slug() . '_message');
        $message = $this->parseBookingInfo($message, $booking_details);
        return [
            'subject' => get_static_option('event_booking_payment_accept_' . LanguageHelper::user_lang_slug() . '_subject'),
            'message' => $message,
        ];
    }
    ...
    {
        $message = get_static_option('event_booking_user_mail_' . LanguageHelper::user_lang_slug() . '_message');
        $message = $this->parseBookingInfo($message, $booking_details);
        return [
            'subject' => get_static_option('event_booking_user_mail_' . LanguageHelper::user_lang_slug() . '_subject'),
            'message' => $message,
        ];
    }
    ...
    {
        $message = get_static_option('event_booking_admin_mail_' . LanguageHelper::user_lang_slug() . '_message');
        $message = $this->parseBookingInfo($message, $booking_details);
        return [
            'subject' => get_static_option('event_booking_admin_mail_' . LanguageHelper::user_lang_slug() . '_subject'),
            'message' => $message,
        ];
    }

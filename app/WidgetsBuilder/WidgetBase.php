...
abstract class WidgetBase
{
    ...
    */
    ...
    public function admin_form_submit_button($text = null){
        ...
        return '<button class="btn btn-success widget_save_change_button">' . $button_text . '</button>';
    }
    ...
    public function admin_form_before(){
        ...
        $markup .= '<h4 class="top-part"><span class="ui-icon ui-icon-arrowthick-2-n-s"></span>'.str_replace(['-','_'],[' ',' '],$this->widget_title()).'</h4>

    ...
    a(document).ready(function () {
        ...
        */
        ...
        a(window).width() < 992 && (a(document).on("click", ".navbar-area .navbar-nav li.menu-item-has-mega-menu>a", function (a) {
            ...
            a.preventDefault()
        })), a(".video-play-btn,.video-popup,.small-vide-play-btn,.video-play,.mfp-video-init,.videos-play").magnificPopup({type: "video"}), a(".image-popup").magnificPopup({
            type: "image",
            gallery: {enabled: !0}
        ...
        // (a commented-out block of dead .home-21 sidebar handlers used to sit
        // here, ending in the niceScroll() call this comma-chain relied on to
        // terminate itself. Removed with niceScroll -- see the "not disturbed"
        // speed-cleanup commit for why -- and the chain closed above instead.)

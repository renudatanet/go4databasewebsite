...
@section('site-title')
    {{__('Appointment Booking Form Builder')}}
@endsection
@section('style')
            ...
            <div class="col-lg-6 mt-5">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="{{route('admin.appointment.booking.form.builder')}}" method="Post">
                            <div class="alert alert-warning">
                                {{__('name, email fields will be added automatically')}}
                            </div>
                            @csrf
                            {!! render_drag_drop_form_builder_markup(get_static_option('appointment_booking_page_form_fields')) !!}

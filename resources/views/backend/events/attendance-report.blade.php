                                   ...
                                   <tr>
                                       ...
                                       <td>
                                           @if($data->status == 'pending')
                                               <span class="badge bg-warning text-dark">{{__($data->status)}}</span>
                                           @else
                                               <span class="badge bg-success text-white">{{__($data->status)}}</span>
                                           @endif
                                       </td>
                                       @php
                                       ...
                                       <td>
                                       @foreach($all_custom_fields_un as $field)
                                           <a class="width_20ch" href="{{url('/').$field}}">{{url('/').$field}}</a>
                                       @endforeach
                                        </td>
                                       @else 
                                       <td></td>

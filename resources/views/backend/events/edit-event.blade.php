                ...
                <div class="card">
                    <div class="card-body">
                        <div class="header-wrap d-flex justify-content-between">
                            ...
                            <a href="{{route('admin.events.all')}}" class="btn btn-primary">{{__('All Events')}}</a>
                        </div>
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="meta_tags"  class="form-control" value="{{$event->meta_tags}}" id="meta_tags">
                                    </div>
                                    <div class="form-group">

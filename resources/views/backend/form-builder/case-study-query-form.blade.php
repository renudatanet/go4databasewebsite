...
@section('site-title')
    {{__('Case Study Query Form Builder')}}
@endsection
@section('style')
    ...
    <div class="col-lg-12 col-ml-12 padding-bottom-30">
        <div class="row">
            ...
            <div class="col-lg-6 mt-5">
                <div class="card">
                    <div class="card-body">
                        <h4 class="header-title">{{__("Case Study Query Form Builder")}}</h4>
                        <form action="{{route('admin.form.builder.case.study.query')}}" method="Post">
                            @csrf
                            {!! render_drag_drop_form_builder_markup(get_static_option('case_study_query_form_fields')) !!}

                                            ...
                                            <div class="card">
                                                ...
                                                <div id="paytm_settings_content" class="collapse"
                                                    ...
                                                    <div class="card-body">
                                                        ...
                                                        <x-media-upload :name="'paytm_preview_logo'" :dimentions="'160x50'" :title="__('Paytm Logo')"/>
                                                        <div class="form-group">
                                            ...
                                            <div class="card">
                                                ...
                                                <div id="razorpay_settings_content" class="collapse"  data-parent="#accordion-payment">
                                                    <div class="card-body">
                                                        ...
                                                        <x-media-upload :name="'razorpay_preview_logo'" :dimentions="'160x50'" :title="__('Razorpay Logo')"/>
                                                        <div class="form-group">
                                            ...
                                            <div class="card">
                                                ...
                                                <div id="paystack_settings_content" class="collapse"  data-parent="#accordion-payment">
                                                    <div class="card-body">
                                                        ...
                                                        <x-media-upload :name="'paystack_preview_logo'" :dimentions="'160x50'" :title="__('PayStack Logo')"/>
                                                        <div class="form-group">
                                            ...
                                            <div class="card">
                                                ...
                                                <div id="mollie_settings_content" class="collapse"  data-parent="#accordion-payment">
                                                    <div class="card-body">
                                                        ...
                                                        <x-media-upload :name="'mollie_preview_logo'" :dimentions="'160x50'" :title="__('Mollie Logo')"/>
                                                        <div class="form-group">
                                            ...
                                            <div class="card">
                                                ...
                                                <div id="flutterwave_settings_content" class="collapse"  data-parent="#accordion-payment">
                                                    <div class="card-body">
                                                        ...
                                                        <x-media-upload :name="'flutterwave_preview_logo'" :dimentions="'160x50'" :title="__('Flutterwave Logo')"/>
                                                        <div class="form-group">

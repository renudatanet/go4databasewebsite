                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="meta_tags"  class="form-control" value="{{$articles->meta_tags}}" id="meta_tags">
                                    </div>
                                    <div class="form-group">
...
@endsection
@section('script')
    <x-backend.auto-slug-js :url="route('admin.knowledge.slug.check')" :type="'update'" />

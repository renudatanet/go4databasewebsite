                    ...
                    <div class="card-body">
                        <div class="header-wrapper d-flex justify-content-between">
                            ...
                            <div class="btn-wrapper">
                                <a class="btn btn-xs btn-secondary btn-sm mb-3 mr-1"  href="{{route('admin.page.edit',$page->id)}}">
                                    {{__('Go Back')}}
                                </a>
                                <a class="btn btn-xs btn-primary btn-sm mb-3 mr-1"  href="{{route('admin.page')}}">
                                     {{__('All pages')}}
                                </a>
                                <a class="btn btn-xs btn-info btn-sm mb-3 mr-1" target="_blank" href="{{route('frontend.dynamic.page',$page->slug)}}">

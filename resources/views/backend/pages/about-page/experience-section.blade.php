    ...
    <div class="col-lg-12 col-ml-12 padding-bottom-30">
        <div class="row">
            ...
            <div class="col-lg-12 mt-t">
                <div class="card">
                    <div class="card-body">
                        <h4 class="header-title">{{__('Experience Section Settings')}}</h4>
                                ...
                                @foreach($all_languages as $key => $lang)
                                    <div class="tab-pane fade @if($key == 0) show active @endif" id="nav-home-{{$lang->slug}}" role="tabpanel" aria-labelledby="nav-home-tab">
                                        <div class="form-group">
                                            <label for="about_page_{{$lang}}_experience_title">{{__('Title')}}</label>
                                        ...
                                        <div class="form-group">
                                            <label for="about_page_{{$lang->slug}}_experience_description">{{__('Description')}}</label>
                                        ...
                                        <div class="form-group">
                                            <label for="about_page_{{$lang->slug}}_quote_text">{{__('Quote Text')}}</label>

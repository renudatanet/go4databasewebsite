            ...
            <div class="col-lg-12 mt-5">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="{{route('admin.case-study')}}" method="post" enctype="multipart/form-data" id="myForm">
                            @csrf
...
@section('script')
    ...
    <x-backend.auto-slug-js :url="route('admin.case-study.slug.check')" :type="'new'"/>
    <script>

            ...
            <div class="col-lg-12 mt-t">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="{{route('admin.home14.counterup')}}" method="post" enctype="multipart/form-data">
                            @csrf
                            <div class="form-group">
                                <label for="home_page_14_counterup_section_background_image">{{__('Background Image')}}</label>
                                @php $signature_image_upload_btn_label = 'Upload Image'; @endphp
                                <div class="media-upload-btn-wrapper">
                                    <div class="img-wrap">
                                        @php
                                            $image_id = get_static_option('home_page_14_counterup_section_background_image');
                                    ...
                                    <input type="hidden" name="home_page_14_counterup_section_background_image" value="{{$image_id}}">

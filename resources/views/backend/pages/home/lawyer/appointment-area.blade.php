            ...
            <div class="col-lg-12 mt-t">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="{{route('admin.home10.appointment')}}" method="post" enctype="multipart/form-data">
                            @csrf
                                ...
                                @foreach($all_languages as $key => $lang)
                                    <div class="tab-pane fade @if(get_default_language() == $lang->slug) show active @endif" id="nav-home-{{$lang->slug}}" role="tabpanel" >
                                        <div class="form-group">
                                            <label for="home_page_10_{{$lang->slug}}_appointment_section_subtitle">{{__('Subtitle')}}</label>
                                            <input type="text" name="home_page_10_{{$lang->slug}}_appointment_section_subtitle" class="form-control" value="{{get_static_option('home_page_10_'.$lang->slug.'_appointment_section_subtitle')}}" >
                                        </div>
                                        <div class="form-group">
                                            <label for="home_page_10_{{$lang->slug}}_appointment_section_title">{{__('Title')}}</label>
                                            <input type="text" name="home_page_10_{{$lang->slug}}_appointment_section_title" class="form-control" value="{{get_static_option('home_page_10_'.$lang->slug.'_appointment_section_title')}}" >
                                        </div>
                                    </div>
                                @endforeach
                            </div>
                            <div class="form-group">
                                <label for="home_page_10_appointment_section_category">{{__('Categories')}}</label>
                                @php
                                ...
                                @endphp
                                <select  name="home_page_10_appointment_section_category[]" class="form-control nice-select wide" multiple>
                            ...
                            <div class="form-group">
                                <label for="home_page_10_appointment_items">{{__('Appointment Items')}}</label>
                                <input type="text" name="home_page_10_appointment_items" class="form-control"  value="{{get_static_option('home_page_10_appointment_items')}}">
                            </div>

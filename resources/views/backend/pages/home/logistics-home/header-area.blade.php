            ...
            <div class="col-lg-12 mt-t">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="{{route('admin.home06.header')}}" method="post" enctype="multipart/form-data">
                            @csrf
                            @php
                                            ...
                                            @foreach($all_languages as $key => $lang)
                                                ...
                                                <div class="tab-pane fade @if($key == 0) show active @endif" id="tab_{{$lang->slug}}_{{$key + $index}}" role="tabpanel" >
                                                    <div class="form-group">
                                                        <label for="home_page_06_{{$lang->slug}}_header_section_title">{{__('Title')}}</label>
                                                        <input type="text" name="home_page_06_{{$lang->slug}}_header_section_title[]" class="form-control" value="{{isset($all_title_fields[$index]) ? $all_title_fields[$index] : ''}}">
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="home_page_06_{{$lang->slug}}_header_section_description">{{__('Description')}}</label>
                                                        <textarea  name="home_page_06_{{$lang->slug}}_header_section_description[]" class="form-control" > {{isset($all_description_fields[$index]) ? $all_description_fields[$index] : ''}}</textarea>
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="home_page_06_{{$lang->slug}}_header_section_button_one_text">{{__('Button One Title')}}</label>
                                                        <input type="text" name="home_page_06_{{$lang->slug}}_header_section_button_one_text[]" class="form-control" value="{{isset($all_btn_one_text_fields[$index]) ? $all_btn_one_text_fields[$index] : ''}}">
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="home_page_06_{{$lang->slug}}_header_section_button_two_text">{{__('Button Two Title')}}</label>
                                                        <input type="text" name="home_page_06_{{$lang->slug}}_header_section_button_two_text[]" class="form-control" value="{{isset($all_btn_two_text_fields[$index]) ? $all_btn_two_text_fields[$index] : ''}}">
                                                    </div>
                                                </div>
                                            @endforeach
                                            <div class="form-group">
                                                <label for="home_page_06_header_section_button_one_url" class="d-block">{{__('Button One Url')}}</label>
                                                <input type="text" class="form-control" value="{{isset($all_button_one_url_fields[$index]) ? $all_button_one_url_fields[$index] : ''}}" name="home_page_06_header_section_button_one_url[]">
                                            </div>
                                            <div class="form-group">
                                                <label for="home_page_06_header_section_button_two_url" class="d-block">{{__('Button Two Url')}}</label>
                                                <input type="text" class="form-control" value="{{isset($all_button_two_url_fields[$index]) ? $all_button_two_url_fields[$index] : ''}}" name="home_page_06_header_section_button_two_url[]">
                                            </div>
                                            <div class="form-group">
                                                <label for="home_page_06_header_section_bg_image">{{__('Background Image')}}</label>
                                                ...
                                                <div class="media-upload-btn-wrapper">
                                                    ...
                                                    <input type="hidden" name="home_page_06_header_section_bg_image[]" value="{{$image_field}}">

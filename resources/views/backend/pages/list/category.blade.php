                                    ...
                                    <div class="table-wrap table-responsive">
                                        ...
                                        @foreach($category as $data)
                                            <tr>
                                                ...
                                                <td>
                                                     <x-delete-popover :url="route('admin.list.category.delete',$data->id)"/>
                                                    <a href="#"
                                                       data-toggle="modal"
            ...
            <div class="col-lg-6 mt-5">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="{{route('admin.list.category')}}" method="post" enctype="multipart/form-data">
                            @csrf
    ...
    <div class="modal fade" id="category_edit_modal" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="{{route('admin.list.category.update')}}"  method="post">

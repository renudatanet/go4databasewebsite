                ...
                <div class="card">
                    <div class="card-body">
                        <div class="header-wrap d-flex justify-content-between">
                            <h4 class="header-title">{{__('New List')}}</h4>
                            <a href="{{route('admin.list')}}" class="btn btn-primary">{{__('All List')}}</a>
                        </div>

                        <form action="{{route('admin.list')}}" method="post" enctype="multipart/form-data" id="myForm">
                            @csrf
                            <div class="row">
                            ...
                            <div class="form-group">
                                <label for="title">{{__('Data Counts')}}</label>
                                <input type="text" class="form-control"  value="{{old('data_counts')}}"  name="data_counts" placeholder="{{__('Data Counts')}}">
                            </div>
                                   </div>
                            <div class="col-sm-3 col-md-3">
                                  <div class="form-group">
                                <label for="title">{{__(' Accuracy Commitment')}}</label>
                                <input type="text" class="form-control"  value="{{old('accuracy_commitment')}}"  name="accuracy_commitment" placeholder="{{__(' Accuracy Commitment')}}">
                            </div>
                            </div>
                             <div class="col-sm-3 col-md-3">
                                    <div class="form-group">
                                ...
                                <select name="subcategories_id" id="sub_category" class="form-control">
                            ...
                            <div class="form-group">
                                      <div class="form-group">
                                <label for="edit_icon_type">{{__('Buyers List')}}</label>
                                <textarea name="buyers_list"  class="form-control" rows="5"></textarea>
                            </div>
                           </div>
                        ...
                        <button type="button" class="add-btn" onclick="addFaq()">+ Add FAQ</button>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="search_title" class="form-control" value="{{ old('search_title') }}" id="search_title" maxlength="191" placeholder="{{__('e.g. Staffing Manager, HR Director')}}">
                            </div>
                            <div class="form-group">
                                <label for="search_industry_business">{{__('Search Industry / Business')}}</label>
                                <input type="text" name="search_industry_business" class="form-control" value="{{ old('search_industry_business') }}" id="search_industry_business" maxlength="191" placeholder="{{__('e.g. Healthcare Staffing Agencies')}}">
                            </div>
                            <div class="form-group">
                                <label for="search_location">{{__('Search Location')}}</label>
                                <input type="text" name="search_location" class="form-control" value="{{ old('search_location') }}" id="search_location" maxlength="191" placeholder="{{__('e.g. United States')}}">
                            </div>
                            <div class="form-group">

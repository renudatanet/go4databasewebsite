...
@section('script')
    ...
    <script>
        $(document).ready(function () {
            ...
            $(document).on('click','#add_custom_links',function (e) {
                ...
                var draggAbleMenuWrap = $('#nestable > ol');
                    ...
                    draggAbleMenuWrap.append('<li class="dd-item" data-id="'+draggAbleMenuLength+'" data-ptype="custom" data-purl="'+menuSlug+'" data-pname="'+menuName+'">\n' +
                        ...
                        '<span class="remove_item">x</span>'+
                        '<span class="expand"><i class="ti-angle-down"></i></span>'+
                        '<div class="dd-body hide"><input type="text" class="anchor_target" placeholder="eg: _blank"/><input type="text" class="icon_picker" placeholder="eg: fas-fa-facebook"/><input type="text" class="menu_title" placeholder="Enter menu title"/></div>'+
                        '</li>');
            ...
            $(document).on('input','.menu_title',function (e) {
                var el = $(this);
                var value = el.val();

                if(value != '' ){
                    el.parent().parent().attr('data-menutitle',value);
                }else{
                    el.parent().parent().removeAttr('data-menutitle');
                }
            });
            ...
            $(document).on('click','#menu_structure_submit_btn',function (e) {
                ...
                //console.log(JSON.stringify(alldata));return false;

...
@section('content')
    <div class="col-lg-12 col-ml-12 padding-bottom-30">
            ...
            <div class="col-lg-12 mt-5">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="{{route('admin.page.update',$page_post->id)}}" method="post" enctype="multipart/form-data"  id="myForm">
                            @csrf
                            <div class="row">
                                <div class="col-lg-8">
        ...
        <textarea name="page_content" id="description">{{ old('content', $page_post->content) }}</textarea>
                                        <!--<input type="hidden" name="page_content" value="{{$page_post->content}}" id="description">-->
                                ...
                                <div class="col-lg-4">
                                    ...
                                    <div class="form-group">
                                        <label for="meta_tags">{{__('Page Title')}}</label>
                                        <input type="text" name="meta_tags"  class="form-control" value="{{$page_post->meta_tags}}" id="meta_tags" maxlength="60">
                                        <span id="titleLengthMessage"></span>
                                    </div>
                                    <div class="form-group">
                                        <label for="meta_description">{{__('Page Meta Description')}}</label>
                                        <textarea name="meta_description"  class="form-control" id="meta_description" maxlength="160">{{$page_post->meta_description}}</textarea>
                                        <span id="descriptionLengthMessage"></span>
                                    </div>
                                    
                                    <div class="form-group">
                                        <label for="schema_code">{{__('Schema')}}</label>
                                        <textarea name="schema_code"  class="form-control" rows="5" id="schema_code ">{{$page_post->schema_code}}</textarea>
                                    </div>

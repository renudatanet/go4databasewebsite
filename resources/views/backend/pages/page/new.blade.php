            ...
            <div class="col-lg-12 mt-5">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="{{route('admin.page.new')}}" method="post" enctype="multipart/form-data"  id="myForm">
                            @csrf
                            <div class="row">
                                <div class="col-lg-8">
                                    ...
                                    <div class="form-group classic-editor-wrapper">
                                        ...
                                        <!--<input type="hidden" name="page_content" id="description">-->
                                        
                                <textarea name="page_content" id="description"></textarea>
                                ...
                                <div class="col-lg-4">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="meta_tags"  class="form-control" id="meta_tags" maxlength="60">
                                        <span id="titleLengthMessage"></span>
                                    </div>
                                    <div class="form-group">
                                        <label for="meta_description">{{__('Page Meta Description')}}</label>
                                        <textarea name="meta_description"  class="form-control" id="meta_description" maxlength="160"></textarea>
                                        <span id="descriptionLengthMessage"></span>
                                    </div>
                                    
                                    <div class="form-group">
                                        <label for="schema_code">{{__('Schema')}}</label>
                                        <textarea name="schema_code"  class="form-control" rows="5" id="schema_code ">{{isset($page_post->schema_code)?$page_post->schema_code:''}}</textarea>
                                    </div>

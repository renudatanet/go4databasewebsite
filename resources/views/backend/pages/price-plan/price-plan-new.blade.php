                ...
                <div class="card">
                    <div class="card-body ">
                        <div class="header-wrap d-flex justify-content-between">
                            ...
                            <a href="{{route('admin.price.plan')}}" class="btn btn-primary">{{__('All Price Plan')}}</a>
                        </div>
                        ...
                        <div class="col-sm-3 col-md-3">
                            <div class="form-group">
                            <label for="price">{{__('Monthly Price')}}</label>
                            <input type="text" class="form-control"  id="monthly_price"  name="monthly_price" placeholder="{{__('Monthly Price')}}">
                            </div>
                        </div>
                        <div class="col-sm-3 col-md-3">
                            <div class="form-group">
                            <label for="price">{{__('Annual Price')}}</label>
                            <input type="text" class="form-control"  id="annual_price"  name="annual_price" placeholder="{{__('Annual Price')}}">
                            </div>
                        </div>
                        
                        <div class="col-sm-3 col-md-3">
                            <div class="form-group">
                            <label for="price">{{__('Monthly Original Price')}}</label>
                            <input type="text" class="form-control"  id="monthly_original_price"  name="monthly_original_price" placeholder="{{__('Monthly Original Price')}}">
                            </div>
                        </div>
                        <div class="col-sm-3 col-md-3">
                            <div class="form-group">
                            <label for="price">{{__('Annual Original Price')}}</label>
                            <input type="text" class="form-control"  id="annual_original_price"  name="annual_original_price" placeholder="{{__('Annual Original Price')}}">
                            </div>
                        </div>
                        
                        <div class="col-sm-3 col-md-3">
                            <div class="form-group">
                            <label for="price">{{__('Monthly Bill Text')}}</label>
                            <input type="text" class="form-control"  id="monthly_bill_text"  name="monthly_bill_text" placeholder="{{__('Monthly Bill Text')}}">
                            </div>
                        </div>
                        
                        <div class="col-sm-3 col-md-3">
                            <div class="form-group">
                            <label for="price">{{__('Annual Bill Text')}}</label>
                            <input type="text" class="form-control"  id="annual_bill_text"  name="annual_bill_text" placeholder="{{__('Annual Bill Text')}}">
                            </div>
                        </div>
                          <div class="col-sm-3 col-md-3">
                               <div class="form-group">

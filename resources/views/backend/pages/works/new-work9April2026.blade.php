                ...
                <div class="card">
                    <div class="card-body">
                        <div class="header-wrap d-flex justify-content-between">
                            <h4 class="header-title">{{__('New B2B')}}</h4>
                            <a href="{{route('admin.work')}}" class="btn btn-primary">{{__('All B2B')}}</a>
                        </div>
                        <form action="{{route('admin.work')}}" method="post" enctype="multipart/form-data" id="myForm">
                            @csrf
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="meta_tags"  class="form-control" id="meta_tags" value="{{old('meta_tags')}}" maxlength="60">
                            ...
                            <button type="submit" class="btn btn-primary mt-4 pr-4 pl-4">{{__('Add New B2B')}}</button>
                        </form>
                    </div>
                </div>
            </div>

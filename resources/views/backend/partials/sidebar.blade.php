...
<div class="sidebar-menu">
 ...
 <li 
                         class="main_dropdown
                        @if(request()->is(['admin-home/author/*','admin-home/author'])) active @endif
                        ">
                            <a href="javascript:void(0)" aria-expanded="true"><i class="ti-write"></i>
                                <span>{{__('Author')}}</span></a>
                            <ul class="collapse">
                                <li class="{{active_menu('admin-home/author')}}"><a
                                            href="{{route('admin.author')}}">{{__('All Author')}}</a></li>
                               
                                <li class="{{active_menu('admin-home/author/new')}}"><a
                                            href="{{route('admin.author.new')}}">{{__('Add New Author')}}</a></li>
                            </ul>
                        </li>
                    ...
                    ">
                        ...
                        <ul class="collapse">
                            <li class="{{active_menu('admin-home/services')}}"><a
                                    href="{{route('admin.services')}}">{{__('All B2C')}}</a></li>
                            <li class="{{active_menu('admin-home/services/new')}}"><a
                                    href="{{route('admin.services.new')}}">{{__('New B2C')}}</a></li>
                            ...
                            <li class="{{active_menu('admin-home/services/page-settings')}}"><a
                                    href="{{route('admin.services.page.settings')}}">{{__('B2C Page')}}</a></li>
                        </ul>
                    </li>
                     <li class="main_dropdown
                    @if(request()->is(['admin-home/list/*','admin-home/list'])) active @endif
                    ">
                        <a href="javascript:void(0)"
                           aria-expanded="true">
                            <i class="ti-layout"></i>
                        ...
                        <ul class="collapse">
                            <li class="{{active_menu('admin-home/list')}}"><a
                                    href="{{route('admin.list')}}">{{__('All List')}}</a></li>
                            <li class="{{active_menu('admin-home/list/new')}}"><a
                                    href="{{route('admin.list.new')}}">{{__('New List')}}</a></li>
                            <li class="{{active_menu('admin-home/list/category')}}"><a
                                    href="{{route('admin.list.category')}}">{{__('Category')}}</a></li>
                       </ul>
                    </li>
                    ...
                    <li class="main_dropdown
                    @if(request()->is(['admin-home/case-study/*','admin-home/case-study'])) active @endif ">
                        <a href="javascript:void(0)"
                           aria-expanded="true">
                            <i class="ti-layout"></i>
                        ...
                        <ul class="collapse">
                            <li class="{{active_menu('admin-home/case-study')}}"><a
                                        href="{{route('admin.case-study')}}">{{__('All Case Study')}}</a></li>
                            <li class="{{active_menu('admin-home/case-study/new')}}"><a
                                    href="{{route('admin.case-study.new')}}">{{__('New Case Study')}}</a></li>
                            <li class="{{active_menu('admin-home/case-study/category')}}"><a
                                        href="{{route('admin.case-study.category')}}">{{__('Category')}}</a></li>
                            <li class="{{active_menu('admin-home/case-study/single-page/settings')}}"><a
                                    href="{{route('admin.case-study.single.page.settings')}}">{{__('Case Single Page Settings')}}</a></li>
                        </ul>
                    </li>
                    ...
                    @if(request()->is(['admin-home/works/*','admin-home/works'])) active @endif ">
                        ...
                        <ul class="collapse">
                            <li class="{{active_menu('admin-home/manage')}}"><a
                                        href="{{route('admin.manage')}}">{{__('Manage Page')}}</a></li>
                            <li class="{{active_menu('admin-home/works')}}"><a
                                        href="{{route('admin.work')}}">{{__('All B2B')}}</a></li>
                            <li class="{{active_menu('admin-home/works/new')}}"><a
                                    href="{{route('admin.work.new')}}">{{__('New B2B')}}</a></li>
                    ...
                    <li class="main_dropdown @if(request()->is('admin-home/general-settings/*')) active @endif">
                        ...
                        <ul class="collapse ">
                            ...
                            <li class="{{active_menu('admin-home/general-settings/email-verifier-content')}}"><a
                                        href="{{route('admin.email.verifier.content')}}">{{__('Email Verifier Page Content')}}</a>
                            </li>
                            ...
                            <li class="{{active_menu('admin-home/general-settings/affiliate-content')}}"><a
                                        href="{{route('admin.affiliate.content')}}">{{__('Affiliate Page Content')}}</a>
                            </li>
                            <li class="{{active_menu('admin-home/general-settings/affiliate-settings')}}"><a
                                        href="{{route('admin.affiliate.settings')}}">{{__('Affiliate Settings')}}</a>
                            </li>
                            <li class="{{active_menu('admin-home/general-settings/affiliate-applications')}}"><a
                                        href="{{route('admin.affiliate.applications')}}">{{__('Affiliate Applications')}}</a>
                            </li>

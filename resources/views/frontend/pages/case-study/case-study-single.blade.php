...
@endsection 
@section('og-meta')
    <meta property="og:url"  content="{{route('frontend.case-study.single',$work_item->slug)}}" />
                ...
                <div class="col-lg-12">
                    <div class="related-work-area padding-top-100">
                        <div class="section-title margin-bottom-30">
                            <h2 class="title">{{get_static_option('case_study_new_'.$user_select_lang_slug.'_related_title')}}</h2>
                        </div>
                            ...
                            @foreach($related_works as $data)
                                <div class="single-related-case-study-item">
                                    ...
                                    <div class="content">
                                        <h4 class="title"><a href="{{route('frontend.case-study.single',$data->slug)}}"> {{$data->title}}</a></h4>
                                    </div>
                                </div>
                            @endforeach
                        </div>

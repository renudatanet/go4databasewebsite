...
@section('site-title')
    {{get_static_option('case_study_page_'.$user_select_lang_slug.'_name')}}
@endsection
@section('page-title')
    {{get_static_option('case_study_page_'.$user_select_lang_slug.'_name')}}
@endsection
@section('page-meta-data')
    <meta name="description" content="{{get_static_option('case_study_page_'.$user_select_lang_slug.'_meta_description')}}">
    <meta name="tags" content="{{get_static_option('case_study_page_'.$user_select_lang_slug.'_meta_tags')}}">
    {!! render_og_meta_image_by_attachment_id(get_static_option('case_study_page_'.$user_select_lang_slug.'_meta_image')) !!}
@endsection
@section('content')
                    ...
                    <div class="case-studies-masonry-wrapper">
                        ...
                        <div class="case-studies-masonry">
                            @foreach($all_work as $data)
                                <div class="col-lg-3 col-md-4 col-sm-6 masonry-item {{get_case_study_category_by_id($data->id,'slug')}}">
                                    <x-frontend.case_study.grid :work="$data" />
                                </div>
                            @endforeach
                        </div>
                    </div>

...
@section('page-meta-data')
    <meta name="description" content="{{ $service_category->meta_description }}">
    <meta name="tags" content="{{ $service_category->meta_tags }}">
...
@section('content')
    <div class="page-content portfolio padding-top-120 padding-bottom-90">
        <div class="container">
           <div id="work-content">
    <div class="row">
        @forelse($service_items as $data)
            <div class="col-lg-6 col-md-6 margin-bottom-40">
                <x-frontend.service.grid :service="$data" />
        ...
        <div class="col-lg-12">
            <nav class="pagination-wrapper" aria-label="Page navigation">
                {{ $service_items->links('vendor.pagination.default') }}
            </nav>
        </div>
    </div>
</div>

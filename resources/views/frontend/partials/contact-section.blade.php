                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="section-title">
                                        <h4 class="title">{{filter_static_option_value('home_page_01_'.$user_select_lang_slug.'_contact_area_title',$static_field_data)}}</h4>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="col-lg-12">
                                        <div class="btn-wrapper">
                                            <button type="submit" id="get_in_touch_submit_btn"
                                                    class="boxed-btn">{{filter_static_option_value('home_page_01_'.$user_select_lang_slug.'_contact_area_button_text',$static_field_data)}}</button>

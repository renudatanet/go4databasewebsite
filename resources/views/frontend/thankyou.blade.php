...
<head>
    ...
    <meta name="description" content="{{get_static_option('site_meta_'.$selected_lang.'_description')}}">
    <meta name="tags" content="{{get_static_option('site_meta_'.$selected_lang.'_tags')}}">

    <title>{{get_static_option('site_'.$selected_lang.'_title')}} - {{get_static_option('site_'.$selected_lang.'_tag_line')}}</title>

...
Route::prefix('admin-home')->middleware(['setlang:backend'])->group(function () {
    ...
    Route::prefix('jobs')->middleware(['adminPermissionCheck:Job Post Manage', 'moduleCheck:job_module_status'])->group(function () {
       ...
       ------------------------------------*/
        ...
        Route::group(['prefix' => 'list'],function () {
         Route::get('/', 'ListController@index')->name('admin.list');
        Route::post('/', 'ListController@store');
        Route::get('/new', 'ListController@new_list')->name('admin.list.new');
        Route::get('/edit/{id}', 'ListController@edit_list')->name('admin.list.edit');
        
        Route::post('/cat-by-slug', 'ListController@category_by_slug')->name('admin.list.category.by.slug');
        
        Route::post('/price-plan-by-slug', 'ListController@price_plan_by_slug')->name('admin.list.price.plan.by.slug');
        Route::post('/update', 'ListController@update')->name('admin.list.update');
        Route::post('/clone', 'ListController@clone_service_as_draft')->name('admin.list.clone');
        Route::post('/bulk-action', 'ListController@bulk_action')->name('admin.list.bulk.action');
        Route::post('/delete/{id}', 'ListController@delete')->name('admin.list.delete');
        Route::post('/slug-check', 'ListController@slug_check')->name('admin.list.slug.check');
        Route::post('/import-csv', 'ListController@importCsv')->name('admin.import-csv');
        Route::post('/datatable', 'ListController@datatable')->name('admin.list.datatable');
        Route::post('/replace-preview', 'ListController@replacePreview')->name('admin.list.replace.preview');
        Route::post('/replace-url', 'ListController@replaceUrl')->name('admin.list.replace.url');
 });
  ...
  /*-----------------------------------
         ...
         ------------------------------------*/
        Route::group(['prefix' => 'list-category' ],function (){
            Route::get('/', 'ListController@category_index')->name('admin.list.category');
            Route::post('/', 'ListController@category_store');
            Route::post('/update', 'ListController@category_update')->name('admin.list.category.update');
            Route::post('/delete/{id}', 'ListController@category_delete')->name('admin.list.category.delete');
            Route::post('/bulk-action', 'ListController@category_bulk_action')->name('admin.list.category.bulk.action');
        });
    ...
    Route::prefix('services')->middleware(['adminPermissionCheck:Services'])->group(function () {
        ...
        Route::post('/import-csv', 'ServiceController@importCsv')->name('admin.import-csv');
        Route::post('/datatable', 'ServiceController@datatable')->name('admin.service.datatable');
        Route::post('/replace-preview', 'ServiceController@replacePreview')->name('admin.service.replace.preview');
        Route::post('/replace-url', 'ServiceController@replaceUrl')->name('admin.service.replace.url');
        Route::post('/get-subcategories','ServiceController@getSubCategories')->name('admin.service.get.subcategories');
        ...
        Route::group(['prefix' => 'sub_category' ],function (){
            Route::get('/', 'ServiceController@sub_category_index')->name('admin.service.sub_category');
            Route::post('/', 'ServiceController@sub_category_store');
            Route::post('/update', 'ServiceController@sub_category_update')->name('admin.service.sub_category.update');
            Route::post('/delete/{id}', 'ServiceController@sub_category_delete')->name('admin.service.sub_category.delete');
            Route::post('/bulk-action', 'ServiceController@sub_category_bulk_action')->name('admin.service.sub_category.bulk.action');
        });
 ...
 /*==============================================
       BLOGS
    ==============================================*/
    Route::prefix('author')->middleware(['adminPermissionCheck:Blogs Manage'])->group(function () {
        /*-------------------------
          Author ROUTES
        -------------------- ------*/
          Route::get('/', 'AuthorController@index')->name('admin.author');
          
        Route::get('/new', 'AuthorController@new_author')->name('admin.author.new');
        Route::post('/new', 'AuthorController@store_new_author');
        Route::post('/clone', 'AuthorController@clone_author')->name('admin.author.clone');
        Route::get('/edit/{id}', 'AuthorController@edit_author')->name('admin.author.edit');
        Route::post('/update/{id}', 'AuthorController@update_author')->name('admin.author.update');
        Route::post('/delete/{id}', 'AuthorController@delete_author')->name('admin.author.delete');
        Route::post('/bulk-action', 'AuthorController@bulk_action')->name('admin.author.bulk.action');
    });
    /*==============================================
       BLOGS
    ==============================================*/
    Route::prefix('blog')->middleware(['adminPermissionCheck:Blogs Manage'])->group(function () {
        ...
        Route::get('/blog-search', 'BlogController@search')->name('admin.blog.search');
        Route::post('/datatable', 'BlogController@datatable')->name('admin.blog.datatable');
        Route::post('/replace-url', 'BlogController@replaceUrl')->name('admin.blog.replace.url');
        Route::post('/replace-preview', 'BlogController@replacePreview')->name('admin.blog.replace.preview');
        Route::get('/admin/run-full-404-scan', 'BlogController@runFullScan')->name('admin.scan.full');
        Route::get('/admin/404-results', 'BlogController@showResults')->name('admin.scan.results');
        Route::get('/admin/scan-progress', 'BlogController@getScanProgress')->name('admin.scan.progress');
...
==============================================*/
    ...
    Route::prefix('page')->middleware(['adminPermissionCheck:Pages Manage'])->group(function () {
        ...
        Route::get('/admin/404-results', 'PagesController@showResults')->name('admin.page.scan.results');
        Route::post('/datatable', 'PagesController@datatable')->name('admin.page.datatable');
        Route::post('/replace-preview', 'PagesController@replacePreview')->name('admin.page.replace.preview');
        Route::get('/admin/run-full-404-scan', 'PagesController@runFullScan')->name('admin.page.scan.full');
        Route::post('/replace-url', 'PagesController@replaceUrl')->name('admin.page.replace.url');
    });
    ...
    Route::prefix('works')->middleware(['adminPermissionCheck:Case Study'])->group(function () {
        ...
        Route::get('/manage', 'WorksController@manage')->name('admin.manage');
        ...
        Route::post('/slug-check', 'WorksController@slug_check')->name('admin.work.slug.check');
         Route::post('/datatable', 'WorksController@datatable')->name('admin.work.datatable');
        Route::post('/replace-preview', 'WorksController@replacePreview')->name('admin.work.replace.preview');
        Route::post('/replace-url', 'WorksController@replaceUrl')->name('admin.work.replace.url');
        ...
        /*----------------------------------------------------
            B2B : SINGLE PAGE SETTINGS ROUTES
        ----------------------------------------------------*/
    ...
    ==============================================*/
    Route::prefix('case-study')->middleware(['adminPermissionCheck:Case Study'])->group(function () {

        Route::get('/', 'CaseStudyController@index')->name('admin.case-study');
        Route::post('/', 'CaseStudyController@store');
        Route::get('/new', 'CaseStudyController@new')->name('admin.case-study.new');
        Route::get('/edit/{id}', 'CaseStudyController@edit')->name('admin.case-study.edit');
        Route::post('/update', 'CaseStudyController@update')->name('admin.case-study.update');
        Route::post('/clone', 'CaseStudyController@clone_new_draft')->name('admin.case-study.clone');
        Route::post('/bulk-action', 'CaseStudyController@bulk_action')->name('admin.case-study.bulk.action');
        Route::post('/delete/{id}', 'CaseStudyController@delete')->name('admin.case-study.delete');
        Route::post('/cat-by-slug', 'CaseStudyController@category_by_slug')->name('admin.case-study.category.by.slug');
        Route::post('/slug-check', 'CaseStudyController@slug_check')->name('admin.case-study.slug.check');
        Route::post('/datatable', 'CaseStudyController@datatable')->name('admin.case-study.datatable');
        Route::post('/replace-preview', 'CaseStudyController@replacePreview')->name('admin.case-study.replace.preview');
        Route::post('/replace-url', 'CaseStudyController@replaceUrl')->name('admin.case-study.replace.url');

        /*----------------------------------------------------
             CASE STUDY : CATEGORY ROUTES
        ----------------------------------------------------*/
        Route::group(['prefix' => 'category'],function (){
            Route::get('/', 'CaseStudyController@category_index')->name('admin.case-study.category');
            Route::post('/', 'CaseStudyController@category_store');
            Route::post('/update', 'CaseStudyController@category_update')->name('admin.case-study.category.update');
            Route::post('/delete/{id}', 'CaseStudyController@category_delete')->name('admin.case-study.category.delete');
            Route::post('/bulk-action', 'CaseStudyController@category_bulk_action')->name('admin.case-study.category.bulk.action');
        });

        /*----------------------------------------------------
            Case Study : SINGLE PAGE SETTINGS ROUTES
        ----------------------------------------------------*/
        Route::get('/single-page/settings', 'CaseStudySinglePageController@case_study_single_page_settings')->name('admin.case-study.single.page.settings');
        Route::post('/single-page/settings', 'CaseStudySinglePageController@update_case_study_single_page_settings');
        /*----------------------------------------------------
           Case Study : PAGE SETTINGS ROUTES
        ----------------------------------------------------*/
        Route::get('/page/settings', 'CaseStudySinglePageController@work_page_settings')->name('admin.case-study.page.settings');
        Route::post('/page/settings', 'CaseStudySinglePageController@update_work_page_settings');
    });

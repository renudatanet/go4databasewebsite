        ...
        <div>
          ...
          <div style="display:flex;flex-direction:column;gap:16px">
            ...
            <a href="#features" class="g4d-footlink"
              ...
              Builder</a>
            <a href="<?php echo e(route('frontend.jobs')); ?>" class="g4d-footlink"
        ...
        <div>
          ...
          <div style="display:flex;flex-direction:column;gap:16px">
            ...
            <a href="https://paypal.com/" class="g4d-footlink"
              ...
              Payment</a>
            <a href="<?php echo e(route('frontend.contact')); ?>" class="g4d-footlink"
 ...
 <!-- Copyright Bar -->
    <div style="background:#6fd943;padding:22px 40px">
      <div
        ...
        <div style="color:#0b132a;font-size:14.5px;font-weight:700;"><?php echo get_footer_copyright_text(); ?>
        ...
        <div style="display:flex;align-items:center;gap:16px">
          ...
          <a href="<?php echo e($data->url); ?>" target="_blank" rel="noopener noreferrer"
            ...
            style="width:32px;height:32px;border-radius:50%;background:rgba(11,19,42,0.12);display:flex;align-items:center;justify-content:center;transition:background 0.2s">
              ...
              <?php echo fa_class_to_svg($data->icon); ?>
...
<!-- load all script -->
<script src="<?php echo e(asset('assets/frontend/js/bootstrap.bundle.min.js')); ?>" defer></script>
<script src="<?php echo e(asset('assets/frontend/js/dynamic-script.js')); ?>" defer></script>
<script src="<?php echo e(asset('assets/frontend/js/jquery.magnific-popup.js')); ?>" defer></script>
<script src="<?php echo e(asset('assets/frontend/js/imagesloaded.pkgd.min.js')); ?>" defer></script>
<script src="<?php echo e(asset('assets/frontend/js/isotope.pkgd.min.js')); ?>" defer></script>
<script src="<?php echo e(asset('assets/frontend/js/jquery.waypoints.js')); ?>" defer></script>
<script src="<?php echo e(asset('assets/frontend/js/jquery.counterup.min.js')); ?>" defer></script>
<script src="<?php echo e(asset('assets/frontend/js/owl.carousel.min.js')); ?>" defer></script>
<script src="<?php echo e(asset('assets/frontend/js/wow.min.js')); ?>" defer></script>
<script src="<?php echo e(asset('assets/frontend/js/jQuery.rProgressbar.min.js')); ?>" defer></script>
<script src="<?php echo e(asset('assets/frontend/js/jquery.mb.YTPlayer.js')); ?>" defer></script>
<script src="<?php echo e(asset('assets/frontend/js/jquery.nicescroll.min.js')); ?>" defer></script>
<script src="<?php echo e(asset('assets/frontend/js/slick.js')); ?>" defer></script>
<script src="<?php echo e(asset('assets/frontend/js/main.js')); ?>" defer></script>
<?php if(\Route::currentRouteName() === 'frontend.products'): ?>
<script src="<?php echo e(asset('assets/frontend/js/jquery-ui.js')); ?>" defer></script>
<?php endif; ?>
<script src="<?php echo e(asset('assets/frontend/js/toastr.min.js')); ?>" defer></script>
...
<?php /**PATH /home/go4database.com/public_html/@core/resources/views/frontend/partials/footer.blade.php ENDPATH**/ ?>
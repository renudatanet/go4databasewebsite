...
<?php endif; ?>
                    ...
                    <div class="post-pagination-wrapper">
                        <!--<?php echo e($all_work->links()); ?>-->
                         <?php echo e($all_work->links('vendor.pagination.default')); ?>
...
<?php echo $__env->make('frontend.frontend-page-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/go4database.com/public_html/@core/resources/views/frontend/pages/work/work.blade.php ENDPATH**/ ?>
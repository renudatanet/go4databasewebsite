...
<meta property="og:url" content="<?php echo e(route('frontend.list.single', [
    'service_slug' => ltrim($service_item->slug, '/')
])); ?>">
    <meta property="og:type" content="article"/>
    <meta property="og:title" content="<?php echo e($list_item->title); ?>"/>
    <?php echo render_og_meta_image_by_attachment_id($list_item->image); ?>

<?php $__env->stopSection(); ?>
<?php $__env->startSection('page-meta-data'); ?>
    <meta name="description" content="<?php echo e($list_item->meta_description); ?>">
    <meta name="tags" content="<?php echo e($list_item->meta_tag); ?>">
    <?php echo render_og_meta_image_by_attachment_id($list_item->image); ?>
...
<?php $__env->startPush('styles'); ?>
    <link rel="stylesheet" href="<?php echo e(asset('assets/frontend/css/list.css')); ?>">  
<?php $__env->stopPush(); ?>
<?php
use App\Services;
...
<nav aria-label="breadcrumb">
    <ul class="breadcrumb">
        ...
        <?php $__currentLoopData = $segments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $segment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            <?php else: ?>
                <li class="breadcrumb-item">
                    <a href="<?php echo e(url($url)); ?>"><?php echo e($title); ?></a>
                </li>
            <?php endif; ?>
  ...
  <div class="filters">
               ...
               <form  enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
    <input type="text" placeholder="Title"  id="search-title" value="<?php echo e($service_item->search_title ?? ''); ?>">
    <input type="text" placeholder="Industry" id="search-industry"  value="<?php echo e($service_item->search_industry ?? ''); ?>">
    <input type="text" placeholder="Business Category" id="search-business" value="<?php echo e($service_item->search_business_category ?? ''); ?>">
    <input type="text" placeholder="Location" id="search-location" value="<?php echo e($service_item->search_location ?? ''); ?>">
...
<i class="fa fa-download"></i>  Download List</a>
 ...
 <p>
    ...
    <ul class="feature-list">
        <li>
         <img src="<?php echo e(asset('assets/uploads/icon.webp')); ?>"  width="25">Job Title</li>
        <li>
         <img src="<?php echo e(asset('assets/uploads/icon.webp')); ?>"  width="25">Industry</li>
        <li>
         <img src="<?php echo e(asset('assets/uploads/icon.webp')); ?>"  width="25">Company</li>
        <li>
         <img src="<?php echo e(asset('assets/uploads/icon.webp')); ?>"  width="25">Location</li>
    </ul>
...
?>
  ...
  <div class="stats">
    ...
    <div class="stat">
      <span><?php echo e($service_item->data_counts); ?></span>
      <p>Data Counts</p>
    </div>
<?php
...
?>
    ...
    <div class="stat">
      <span><?php echo e($lastUpdated->format('d-F-Y')); ?></span>
      <p>Last updated</p>
    </div>
  ...
  <div class="logo-slider">
    ...
    <!-- Original Logos -->
    <img src="<?php echo e(asset('assets/uploads/product/Candela.png')); ?>" width="92">
    <img src="<?php echo e(asset('assets/uploads/product/Tecan.png')); ?>" width="89">
    <img src="<?php echo e(asset('assets/uploads/product/Westin.png')); ?>"  width="66">
    <img src="<?php echo e(asset('assets/uploads/product/CBRE.png')); ?>"width="66">
    <img src="<?php echo e(asset('assets/uploads/product/Shopify.png')); ?>" width="46">
    <img src="<?php echo e(asset('assets/uploads/product/MIQ.png')); ?>"   width="68">
    <img src="<?php echo e(asset('assets/uploads/product/J Pocker.png')); ?>"  width="68">
...
<div class="stat-comp">
      <div class="stat-comp-icon">
        <img src="<?php echo e(asset('assets/uploads/icon.webp')); ?>"  width="30">   
    </div>
      <p>GDPR Compliance</p>
    </div>
  ...
  <p class="description"> <?php echo e(strip_tags($service_item->description)); ?>
...
<div class="green-banner">
       ...
       <img src="<?php echo e(asset('assets/uploads/icon.webp')); ?>"  width="60">

    <div class="banner-text">
        Get Instant Access to <?php echo e($service_item->data_counts); ?> Verified <?php echo e($emailTitle); ?>
...
<a href="https://app.go4database.com/login?utm_source=ProductPage&amp;utm_medium=Internal&amp;utm_campaign=app_login" class="read-btn" target="_blank">
   Have you requested for free sample data yet?</a>
      ...
      <h2 class="title">
        Get Instant Access to 1200+ <?php echo e($mailingTitle); ?>

      </h2>

      <div class="tags">

        <div class="tag"><img src="<?php echo e(asset('assets/uploads/product/Verified Contacts.png')); ?>" width="46">Verified Contacts</div>
        <div class="tag"><img src="<?php echo e(asset('assets/uploads/product/Decision Makers.png')); ?>"  width="46">Decision Makers</div>
        <div class="tag"><img src="<?php echo e(asset('assets/uploads/product/GEO Targeting.png')); ?>"  width="46">GEO Targeting</div>
        <div class="tag"><img src="<?php echo e(asset('assets/uploads/product/High ROI Driven.png')); ?>"  width="46">High ROI Driven</div>
  ...
  <div class="related-box">
    ...
    <div class="tab-content">
      ...
      <div class="tab-pane fade show active"
        ...
        <ul>
        <?php $__currentLoopData = $relatedServices; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <li>
        <a href="<?php echo e(route('frontend.list.single', [
      ...
      <div class="tab-pane fade"
        ...
        <ul>
           <?php $__currentLoopData = $all_serviceCat; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<li>
    <a href="<?php echo e($exists
        ? route('frontend.list.single', ['service_slug' => $item->slug])
        : 'javascript:void(0)'); ?>"
       target="_blank">
        <?php echo e($item->name); ?> Email List
    </a>
</li>
    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </ul>
  ...
  <div class="section-flex">
    ...
    <div class="left">
      ...
      <h2 class="title">
        Why Our <?php echo e($contactListTitle); ?> Delivers Better ROI
      </h2>
...
<div class="slider-container">
  <div class="slider-header">
   ...
   <?php $__currentLoopData = $all_testimonial; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $testimonial): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
  <div class="testimonial-slide  <?php echo e($loop->first ? 'active' : ''); ?>">
    <div class="testimonial">

    <?php echo e(\Illuminate\Support\Str::limit(strip_tags($testimonial->description), 180)); ?>
  ...
  <div class="read-more"><a href="<?php echo e(url('/our-testimonial')); ?>">Read all Testimonial →</a></div>
</div>
  ...
  <div class="section-flex"  >
    ...
    <div class="left">
      ...
      <h2 class="title">
        Simple steps to get free <?php echo e($contactDatabaseTitle); ?>

      </h2>
<video width="100%" controls class="video-box">
    <source src="<?php echo e(env('VIDEO_CDN')); ?>" type="video/mp4">
    <source src="<?php echo e(env('VIDEO_CDN')); ?>" type="video/mp4">
 
</video>


      <!-- <div class="video-box" style="background-image: url(<?php echo e(asset('assets/uploads/product/list.png')); ?>);">
        ▶
      </div> -->
...
<?php endif; ?>
  <form action="<?php echo e(route('service-lead.submit')); ?>" method="POST">
        <?php echo csrf_field(); ?>
  ...
  <div class="trust">
    ...
    <div class="trust-item">
      <img src="<?php echo e(asset('assets/uploads/product/Trustpilot.webp')); ?>">
      <div class="rating-box">
      <div class="rating-text"> 4.5 </div><div class="stars">★★★★★</div>
    </div>
    </div>
    <div class="trust-item">
     <img src="<?php echo e(asset('assets/uploads/product/G2.webp')); ?>"   style="width:40px!important;">
    <div class="rating-box">
      <div class="rating-text"> 4.5 </div><div class="stars">★★★★★</div>
    </div>
   </div>
    ...
    <div class="trust-item">
      <img src="<?php echo e(asset('assets/uploads/product/datarade.webp')); ?>">
 <div class="rating-box">
      <div class="rating-text"> 4.5 </div><div class="stars">★★★★★</div>
    </div>
</div>
    ...
    <div class="trust-item">
      <img src="<?php echo e(asset('assets/uploads/product/BBB.webp')); ?>">
   <div class="rating-box">
      <div class="rating-text"> 4.5 </div><div class="stars">★★★★★</div>
    </div>
  </div>
...
Key Decision Makers in the <?php echo e($emailTitle); ?>

</h2>

<div class="decision-table">
    <?php if(!empty($service_item->key_decision)): ?>
    <div class="vertical-table">
        <?php $__currentLoopData = explode(',', $service_item->key_decision); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pair): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <?php
            ...
            <?php if(count($parts) == 2): ?>
                <div class="table-row">
                    <div class="table-label"><?php echo e(trim($parts[0])); ?></div>
                    <div class="table-value"><?php echo e(trim($parts[1])); ?></div>
                </div>
            <?php endif; ?>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    </div>
...
<div class="icon-item">
<div class="icon"><img src="<?php echo e(asset('assets/uploads/product/Industry - Green.png')); ?>"></div>
<p>Industry</p>
</div>

<div class="icon-item">
<div class="icon"><img src="<?php echo e(asset('assets/uploads/product/Job Titile - Green.png')); ?>"></div>
<p>Job Title</p>
</div>

<div class="icon-item">
<div class="icon"><img src="<?php echo e(asset('assets/uploads/product/Location - White.png')); ?>"></div>
<p>Location</p>
</div>

<div class="icon-item">
<div class="icon"><img src="<?php echo e(asset('assets/uploads/product/Employee Size - Green.png')); ?>"></div>
<p>Employee Size</p>
</div>

<div class="icon-item">
<div class="icon"><img src="<?php echo e(asset('assets/uploads/product/Reveue Size - Green.png')); ?>"></div>
<p>Revenue Size</p>
</div>
...
<h2 class="section-title">
Who Can Benefit from Our <?php echo e($mailingTitle); ?> to Boost ROI?
</h2>
...
<div class="check"><img src="<?php echo e(asset('assets/uploads/icon.webp')); ?>"  width="30"></div>
...
<div class="industry-section">
    ...
    <div class="industry-flex">
        ...
        <div class="industry-tabs">
            ...
            <?php $__currentLoopData = $all_serviceCat; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>

            <button class="industry-tab-btn <?php echo e($key == 0 ? 'active' : ''); ?>"
                    data-tab="industry<?php echo e($category->id); ?>">
...
?>
     <?php $__currentLoopData = $titles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $title => $slug): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<div class="green-banner">
    ...
    <div class="banner-text">
        Unlock <?php echo e($service_item->data_counts); ?> Verified <?php echo e($contactListTitle); ?> Today
    </div>
<a href="https://app.go4database.com/login?utm_source=ProductPage&amp;utm_medium=Internal&amp;utm_campaign=app_login" class="read-btn" target="_blank">
   Have you requested for free sample data yet?</a>
</div>
...
<div class="faq-wrapper">
    ...
    <?php if(!empty($service_item->faqs)): ?>
        ...
        <?php $__currentLoopData = $service_item->faqs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $faq): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php if(session('sample-success')): ?>
    <div class="alert alert-success">
        <?php echo e(session('sample-success')); ?>

    </div>
<?php endif; ?>
              <form action="<?php echo e(route('sample-lead.submit')); ?>" method="POST">
    <?php echo csrf_field(); ?>
...
<section class="related-blogs py-5">
 ...
 <div class="carousel-inner">
    ...
    <?php $__currentLoopData = $relatedBlogs->chunk(3); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $blogs): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('frontend.frontend-page-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/go4database.com/public_html/@core/resources/views/frontend/pages/list/list-single.blade.php ENDPATH**/ ?>
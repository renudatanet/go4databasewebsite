...
<link rel="stylesheet" href="<?php echo e(asset('assets/frontend/css/pricing.css')); ?>">
<?php $__env->stopPush(); ?>
...
<?php $__currentLoopData = $price_plan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
      <!-- FREE PLAN -->
      <div class="pricing-card  <?php if(!empty($data->highlight)): ?>  selected <?php endif; ?>" id="card-free">
        ...
        <div class="card-header">
          <div class="badge-row">
            <span class="plan-badge"><?php echo e($data->title); ?></span>
            <?php if(!empty($data->highlight)): ?> 
          ...
          <p class="plan-desc">Perfect for getting started</p>
           <?php if($data->monthly_original_price != -1): ?>
          <div class="price-container">
              
              
            <span class="price-symbol">$</span>
            
            <span class="price-amount" data-monthly="<?php echo e($data->monthly_price); ?>" data-annual="<?php echo e($data->annual_price); ?>"><?php echo e($data->annual_price); ?></span>
            <del class="original-price" data-monthly="$<?php echo e($data->monthly_original_price); ?>" data-annual="$<?php echo e($data->annual_original_price); ?>">$<?php echo e($data->annual_original_price); ?></del>
          ...
          <?php endif; ?>
          <p class="price-sub bill-desc" data-monthly="<?php echo e($data->monthly_bill_text); ?>" data-annual="<?php echo e($data->annual_bill_text); ?>"><?php echo e($data->annual_bill_text); ?></p>
        ...
        <div class="card-features">
          <ul>
              ...
              <i data-lucide="check" class="feature-icon check"></i><?php echo e($item); ?></li>
...
<div class="card-footer">
    ...
    <?php if($a == 1): ?>
        ...
        <a href="https://app.go4database.com/register?plan_id=<?php echo e($data->id); ?>&&frequency=annually"
           target="_blank"
           class="plan-button plan-link <?php if(!empty($data->highlight)): ?> select-btn selected-btn <?php endif; ?> primary-outline-btn" data-plan-id="<?php echo e($data->id); ?>"  target="_blank" >
            <i data-lucide="check" class="btn-check-icon"></i>
            <?php echo e($data->btn_text); ?>
    ...
    <?php elseif($a == 2 || $a == 3): ?>
        ...
        <a href="https://app.go4database.com/register?plan_id=<?php echo e($data->id); ?>&frequency=annually"
class="plan-button plan-link <?php if(!empty($data->highlight)): ?> select-btn selected-btn <?php endif; ?> primary-outline-btn"
data-plan-id="<?php echo e($data->id); ?>"  target="_blank" >
            <i data-lucide="check" class="btn-check-icon"></i>
            <?php echo e($data->btn_text); ?>
...
<?php $__env->startPush('script'); ?>
 <!-- Lucide Icons and Script -->
  ...
  <script src="<?php echo e(asset('assets/frontend/js/pricing.js')); ?>"></script>
  <script>
...
<?php echo $__env->make('frontend.frontend-page-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/go4database.com/public_html/@core/resources/views/frontend/pages/price-plan.blade.php ENDPATH**/ ?>
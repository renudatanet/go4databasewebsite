...
.mega-menu-item {
    ...
    <header class="g4d-sticky-nav">
      <nav
        ...
        <a href="<?php echo e(url('/')); ?>" style="display:flex;align-items:center;flex-shrink:0">
            <?php if(!empty(filter_static_option_value('site_logo',$global_static_field_data))): ?>
                            <?php echo render_logo_image_markup_by_attachment_id(filter_static_option_value('site_logo',$global_static_field_data)); ?>
    ...
    </header><?php /**PATH /home/go4database.com/public_html/@core/resources/views/frontend/partials/navbar-variant/navbar-04.blade.php ENDPATH**/ ?>
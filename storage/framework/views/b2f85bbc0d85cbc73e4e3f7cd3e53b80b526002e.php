...
<?php echo $__env->make('frontend.partials.navbar-new', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?> 
<?php $__env->startPush('styles'); ?>
    <link rel="stylesheet" href="<?php echo e(asset('assets/frontend/css/home.css?v=123')); ?>">
<?php $__env->stopPush(); ?>
 <!-- ═══════════════════════════════════════════════════════
...
<div class="offer-badge">
          ...
          <div
            ...
            <img src="<?php echo e(asset('assets/frontend/images/free-credits-promo.png')); ?>" alt="1200 Free Credits Offer" style="width:100%;max-width:440px;height:auto;display:block;object-fit:contain;
      ...
      <div style="max-width:1200px;margin:0 auto">
        ...
        <div class="stacking-cards-container">
          ...
          <div class="clay-card-stack"
            ...
            <div>
              <div style="display:flex;align-items:center;gap:14px;margin-bottom:18px;margin-top:-6px;flex-wrap:wrap">
                <img src="<?php echo e(asset('assets/frontend/images/logo.png')); ?>" alt="Go4Database Logo"
            ...
            <div
              ...
              <img src="<?php echo e(asset('assets/frontend/images/b2b-marketplace-table.png')); ?>" alt="Go4Database B2B leads table with company, contact name, title and verified email"
          ...
          <div class="clay-card-stack"
            ...
            <div
              style="background:#fff;border-radius:18px;padding:10px;box-shadow:0 20px 50px -15px rgba(0,0,0,0.12);border:1px solid rgba(0,0,0,0.08);overflow:hidden">
              <img src="<?php echo e(asset('assets/frontend/images/advanced-filters-form.png')); ?>" alt="Go4Database advanced filters for company, industry, technology, turnover, title and seniority"
          ...
          <div class="clay-card-stack"
            ...
            <div
              style="background:#fff;border-radius:18px;padding:10px;box-shadow:0 20px 50px -15px rgba(0,0,0,0.12);border:1px solid rgba(0,0,0,0.08);overflow:hidden">
              <img src="<?php echo e(asset('assets/frontend/images/ai-lead-finder.png')); ?> " alt="AI Suggestions & Lead Finder Platform Screenshot"
                style="width:100%;height:auto;border-radius:12px;display:block;object-fit:cover">
            </div>
          </div>
...
<div id="case-studies"
  ...
  <div style="max-width:1200px;margin:0 auto">
    ...
    <?php if($testimonials_for_js->isNotEmpty()): ?>
    ...
    <div class="testimonial-split-grid"
      ...
      <div style="position:relative">
        <div id="anim-avatar-container"
          ...
          <?php $__currentLoopData = $testimonials_for_js; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
          <?php
          ...
          ?>
          <!-- Animated Avatar Card <?php echo e($loop->index); ?> -->
          <div class="anim-avatar-card" id="anim-card-<?php echo e($loop->index); ?>"
            style="background:<?php echo e($card_bg); ?>;color:#0b132a;display:flex;flex-direction:column;align-items:center;justify-content:center;padding:32px;text-align:center;border:1.5px solid <?php echo e($card_border); ?>;box-shadow:<?php echo e($card_shadow); ?>">
            <div
              style="width:90px;height:90px;border-radius:50%;background:<?php echo e($avatar_bg); ?>;color:<?php echo e($avatar_color); ?>;font-size:32px;font-weight:900;display:flex;align-items:center;justify-content:center;margin-bottom:20px;box-shadow:<?php echo e($avatar_shadow); ?>">
              <?php echo e($initials); ?>

            </div>
            <div style="font-size:22px;font-weight:800;color:#0b132a"><?php echo e($data->name); ?></div>
            <div style="font-size:14px;color:#475569;margin-top:4px"><?php echo e($data->designation); ?></div>
            <div
              ...
              <?php echo e($data->metric ?? 'Verified Customer'); ?>
      ...
      <div>
        <div style="display:flex;align-items:center;gap:12px;margin-bottom:20px">
          <span id="anim-rating-text" style="color:#10b981;font-size:18px"><?php echo e(str_repeat('★', $first_testimonial->rating ?? 5)); ?><?php echo e(str_repeat('☆', 5 - ($first_testimonial->rating ?? 5))); ?></span>
          <span id="anim-metric-badge"
            style="background:#e8f7ea;color:#1f7a2e;font-size:12.5px;font-weight:800;padding:4px 14px;border-radius:999px;border:1px solid rgba(31,122,46,0.18)"><?php echo e($first_testimonial->metric ?? ''); ?></span>
        </div>
        ...
        <div id="anim-quote-text"
          ...
          "<?php echo e($first_testimonial->description ?? ''); ?>"
        </div>
        ...
        <div
          ...
          <div>
            <div id="anim-author-name" style="font-size:19px;font-weight:800;color:#0f172a"><?php echo e($first_testimonial->name ?? ''); ?></div>
            <div id="anim-author-role" style="font-size:14px;color:#64748b;margin-top:2px"><?php echo e($first_testimonial->designation ?? ''); ?></div>
          </div>
    ...
    ?>
    <script>
      window.__TESTIMONIALS__ = <?php echo json_encode($testimonials_json, 15, 512) ?>;
    </script>
    <?php endif; ?>
...
<div class="fav-section-wrapper">
        ...
        <div class="fav-tabs-pill-wrap">
          <div class="fav-tabs-nav" id="favTabs">
            ...
            <div class="fav-tab-btn" onclick="filterFavCards('<?php echo e(Str::slug($data->name)); ?>', this)"><?php echo e($data->name); ?></div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </div>
        </div>
...
<?php $__currentLoopData = $all_work; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    ...
    <a href="<?php echo e(route('frontend.work.single',$data->slug)); ?>"
       ...
       data-category="<?php echo e(Str::slug(trim(get_work_category_by_id($data->id, 'slug')))); ?>"
       style="
           text-decoration:none;
           display:flex;
           flex-direction:column;
           background:<?php echo e($style['background']); ?>;
           border:1.5px solid <?php echo e($style['border']); ?>;
           border-radius:24px;
           padding:32px 28px;
           gap:14px;
           transition:all 0.3s ease;
           box-shadow:0 8px 24px <?php echo e($style['shadow']); ?>;
       ">
        ...
        <div style="display:flex;align-items:center;justify-content:space-between;">
            ...
            ">
                <?php echo e(get_work_category_by_id($data->id, 'string')); ?>
        ...
        <div style="
            ...
            font-weight:500;
        ">
            <?php echo e(\Illuminate\Support\Str::words(strip_tags($data->description), 20, '...')); ?>
...
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        ...
        <div style="display:flex;justify-content:center;margin-top:44px">
          <a href="<?php echo e(route('frontend.work')); ?>" class="fav-cta-btn">
            <span>Know More</span>
...
<div style="max-width:1240px;margin:0 auto">
        ...
        <div
          ...
          <div>
            ...
            <h2 style="font-size:40px;font-weight:800;letter-spacing:-1.3px;color:#0f172a;line-height:1.15">
             <?php echo e(filter_static_option_value('home_page_01_'.$user_select_lang_slug.'_latest_news_description',$static_field_data)); ?> 
            </h2>
          </div>
        </div>
  ...
  <?php $__currentLoopData = $all_blog; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
          <!-- Card 1 -->
          <div class="blog-card-hover blog-item" data-category="<?php echo e(get_blog_category_name_by_id($data->blog_categories_id)); ?>" onclick="openBlogArticle(<?php echo e($data->id); ?>)">
              ...
              <div
                ...
                <div style="font-size:15px;font-weight:900;line-height:1"><?php echo e(date_format($data->created_at,'d')); ?></div>
                <div style="font-size:11px;font-weight:800;line-height:1;margin-top:2px"><?php echo e(date_format($data->created_at,'M')); ?></div>
              </div>
            </div>
            <div
              ...
              <div>
                <div style="font-size:12.5px;color:#64748b;font-weight:600;margin-bottom:8px"><?php echo e(date_format($data->created_at,'d M Y')); ?> • 6 min read
                </div>
                ...
                <div style="font-size:14px;color:#475569;line-height:1.6;margin-bottom:20px">
                 <?php echo e(\Illuminate\Support\Str::words(strip_tags($data->content), 30, '...')); ?>
...
?>
                   <div
                    ...
                    <?php echo e($author_initials); ?></div>
                  <span style="font-size:12.5px;font-weight:700;color:#334155"><?php echo e($data->authorData->name); ?></span>
                </div>
                <span
                  style="color:#15803d;font-size:13.5px;font-weight:800;display:inline-flex;align-items:center;gap:4px">
                  <a href="<?php echo e(route('frontend.blog.single',$data->slug)); ?>" style="color:inherit;text-decoration:underline">Read Article &rarr;</a>
                </span>
              </div>
            </div>
          </div>
...
<script>
    const blogArticlesData = <?php echo json_encode($blogArticlesData, 15, 512) ?>;
</script>
    ...
    <div id="blog-reader-modal"
      ...
      <div
        ...
        <div style="padding:28px 36px 0">
          <img id="modal-blog-img" src="<?php echo e(asset('assets/frontend/images/blog1.jpg')); ?>" alt="Article Banner"
...
<span class="trusted-text-logo"
  ...
  <?php if(\App\Http\Controllers\WebsiteLeadsLocalProxyController::enabled()): ?>
    
    <script>
      window.G4D_LEADS_API = <?php echo json_encode(route('local.website.leads'), 15, 512) ?>;
      window.G4D_LEADS_CONTACT_API = <?php echo json_encode(route('local.website.leads.contact'), 15, 512) ?>;
    </script>
  <?php endif; ?>
  
  <script src="<?php echo e(asset('assets/frontend/js/home-01.js')); ?>?v=7" defer></script>
...
<?php echo $__env->make('frontend.partials.chat-widget', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php /**PATH /home/go4database.com/public_html/@core/resources/views/frontend/home-pages/home-01.blade.php ENDPATH**/ ?>
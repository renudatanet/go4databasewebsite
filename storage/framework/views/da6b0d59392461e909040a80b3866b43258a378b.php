            ...
            <div class="row">
                <div class="col-lg-12 col-md-12">
                    <div class="section-title desktop-center padding-bottom-55">
                        <h2 class="title"><?php echo e(get_static_option('about_page_'.$user_select_lang_slug.'_team_member_section_title')); ?></h2>
                    ...
                    >
                        <?php $__currentLoopData = $all_team_members; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="team-section team-member-style-01">
                                ...
                                <div class="team-text">
                                    <h2 class="title"><?php echo e($data->name); ?></h2>
...
<?php endif; ?><?php /**PATH /home/go4database.com/public_html/@core/resources/views/frontend/partials/about-page-content.blade.php ENDPATH**/ ?>
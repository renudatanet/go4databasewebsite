...
?>
        <!DOCTYPE html>
<html lang="<?php echo e($user_select_lang_slug ?? 'en'); ?>"  dir="<?php echo e(get_user_lang_direction()); ?>">
...
<link rel="preload" href="<?php echo e(asset('assets/frontend/webfonts/fa-brands-400.woff2')); ?>" as="font" type="font/woff2" crossorigin>
<link rel="preload" href="<?php echo e(asset('assets/frontend/webfonts/fa-solid-900.woff2')); ?>" as="font" type="font/woff2" crossorigin>
    
<!-- Preload key CSS (icons, layout, main styles) -->
<link rel="preload" href="<?php echo e(asset('assets/frontend/css/bootstrap.min.css')); ?>" as="style" onload="this.onload=null;this.rel='stylesheet'">
<link rel="preload" href="<?php echo e(asset('assets/frontend/css/style.css')); ?>" as="style" onload="this.onload=null;this.rel='stylesheet'">

<!-- Other styles loaded normally but not render-blocking -->
<link rel="stylesheet" href="<?php echo e(asset('assets/frontend/css/fontawesome.min.css')); ?>" media="print" onload="this.media='all'">
<link rel="stylesheet" href="<?php echo e(asset('assets/frontend/css/flaticon.css')); ?>" media="print" onload="this.media='all'">
<link rel="stylesheet" href="<?php echo e(asset('assets/frontend/css/nexicon.css')); ?>" media="print" onload="this.media='all'">
<link rel="stylesheet" href="<?php echo e(asset('assets/frontend/css/owl.carousel.min.css')); ?>" media="print" onload="this.media='all'">
<link rel="stylesheet" href="<?php echo e(asset('assets/frontend/css/animate.css')); ?>" media="print" onload="this.media='all'">
<link rel="stylesheet" href="<?php echo e(asset('assets/frontend/css/magnific-popup.css')); ?>" media="print" onload="this.media='all'">
<link rel="stylesheet" href="<?php echo e(asset('assets/frontend/css/style-two.css')); ?>" media="print" onload="this.media='all'">
<link rel="stylesheet" href="<?php echo e(asset('assets/frontend/css/helpers.css')); ?>" media="print" onload="this.media='all'">
<link rel="stylesheet" href="<?php echo e(asset('assets/frontend/css/responsive.css')); ?>" media="print" onload="this.media='all'">
<link rel="stylesheet" href="<?php echo e(asset('assets/frontend/css/jquery.ihavecookies.css')); ?>" media="print" onload="this.media='all'">
<link rel="stylesheet" href="<?php echo e(asset('assets/frontend/css/dynamic-style.css')); ?>" media="print" onload="this.media='all'">
<link rel="stylesheet" href="<?php echo e(asset('assets/frontend/css/toastr.css')); ?>" media="print" onload="this.media='all'">
<link rel="stylesheet" href="<?php echo e(asset('assets/frontend/css/slick.css')); ?>" media="print" onload="this.media='all'">
<link rel="stylesheet" href="<?php echo e(asset('assets/frontend/css/jquery.mb.YTPlayer.min.css')); ?>" media="print" onload="this.media='all'">
...
<noscript>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('assets/frontend/css/style.css?v=123')); ?>">
    ...
    <link rel="stylesheet" href="<?php echo e(asset('assets/frontend/css/jquery.mb.YTPlayer.min.css')); ?>">
...
<?php if(file_exists('assets/frontend/css/home-'.$home_page_variant.'.css') && empty(get_static_option('home_page_page_builder_status'))): ?>
    ...
    <script src="<?php echo e(asset('assets/frontend/js/jquery-3.4.1.min.js')); ?>" defer></script>
    <script src="<?php echo e(asset('assets/frontend/js/jquery-migrate-3.1.0.min.js')); ?>" defer></script>
...
<?php /**PATH /home/go4database.com/public_html/@core/resources/views/frontend/partials/header.blade.php ENDPATH**/ ?>